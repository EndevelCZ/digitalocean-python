...
class DropletActionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_droplet_action_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/droplets/{droplet_id}/actions/{action_id}',
                'operation_id': 'get_droplet_action',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_droplet_actions_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/droplets/{droplet_id}/actions',
                'operation_id': 'list_droplet_actions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.post_droplet_action_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/droplets/{droplet_id}/actions',
                'operation_id': 'post_droplet_action',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.post_droplet_action_by_tag_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/droplets/actions',
                'operation_id': 'post_droplet_action_by_tag',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_droplet_action(
        self,
        droplet_id,
        action_id,
        **kwargs
    ):
        """Retrieve a Droplet Action  # noqa: E501

        To retrieve a Droplet action, send a GET request to `/v2/droplets/$DROPLET_ID/actions/$ACTION_ID`.  The response will be a JSON object with a key called `action`. The value will be a Droplet action object.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_droplet_action(droplet_id, action_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['action_id'] = \
            action_id
        return self.get_droplet_action_endpoint.call_with_http_info(**kwargs)

    def list_droplet_actions(
        self,
        droplet_id,
        **kwargs
    ):
        """List Actions for a Droplet  # noqa: E501

        To retrieve a list of all actions that have been executed for a Droplet, send a GET request to `/v2/droplets/$DROPLET_ID/actions`.  The results will be returned as a JSON object with an `actions` key. This will be set to an array filled with `action` objects containing the standard `action` attributes.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_droplet_actions(droplet_id, async_req=True)
        >>> result = thread.get()
    ...
    def post_droplet_action(
        ...
        **kwargs
        ...
        Keyword Args:
            unknown_base_type (UNKNOWN_BASE_TYPE): The `type` attribute set in the request body will specify the  action that will be taken on the Droplet. Some actions will require additional attributes to be set as well. . [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['droplet_id'] = \
            droplet_id
        return self.post_droplet_action_endpoint.call_with_http_info(**kwargs)

    def post_droplet_action_by_tag(
        self,
        **kwargs
    ):
        """Acting on Tagged Droplets  # noqa: E501
        ...
        >>> thread = api.post_droplet_action_by_tag(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.post_droplet_action_by_tag_endpoint.call_with_http_info(**kwargs)
