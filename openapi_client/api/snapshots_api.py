...
class SnapshotsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_snapshot_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v2/snapshots/{snapshot_id}',
        ...
        self.list_all_snapshots_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/snapshots',
                'operation_id': 'list_all_snapshots',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def delete_snapshot(
        ...
        **kwargs
        ...
        Both Droplet and volume snapshots are managed through the `/v2/snapshots/` endpoint. To delete a snapshot, send a DELETE request to `/v2/snapshots/$SNAPSHOT_ID`.  A status of 204 will be given. This indicates that the request was processed successfully, but that no response body is needed.   # noqa: E501
    ...
    def get_snapshot(
        ...
        **kwargs
        ...
        """Retrieve an Existing Snapshot  # noqa: E501

        To retrieve information about a snapshot, send a GET request to `/v2/snapshots/$SNAPSHOT_ID`.  The response will be a JSON object with a key called `snapshot`. The value of this will be an snapshot object containing the standard snapshot attributes.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_all_snapshots(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_all_snapshots_endpoint.call_with_http_info(**kwargs)
