...
class ProjectsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_project_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v2/projects/{project_id}',
        ...
        self.get_default_project_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/projects/default',
        ...
        self.patch_default_project_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/projects/default',
                'operation_id': 'patch_default_project',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.update_default_project_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/projects/default',
                'operation_id': 'update_default_project',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def create_project(
        ...
        **kwargs
        ...
        To create a project, send a POST request to `/v2/projects`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_project(unknown_base_type, async_req=True)
        >>> result = thread.get()
    ...
    def get_default_project(
        ...
        **kwargs
        ...
        """Retrieve the Default Project  # noqa: E501

        To get your default project, send a GET request to `/v2/projects/default`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_default_project_endpoint.call_with_http_info(**kwargs)
    ...
    def get_project(
        ...
        **kwargs
        ...
        """Retrieve an Existing Project  # noqa: E501

        To get a project, send a GET request to `/v2/projects/$PROJECT_ID`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_projects(
        ...
        **kwargs
        ...
        To list all your projects, send a GET request to `/v2/projects`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def patch_default_project(
        self,
        project,
        **kwargs
    ):
        """Patch the Default Project  # noqa: E501

        To update only specific attributes of a project, send a PATCH request to `/v2/projects/default`. At least one of the following attributes needs to be sent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_default_project(project, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project'] = \
            project
        return self.patch_default_project_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_project(
        ...
        **kwargs
        ...
        To update only specific attributes of a project, send a PATCH request to `/v2/projects/$PROJECT_ID`. At least one of the following attributes needs to be sent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_project(project_id, project, async_req=True)
        >>> result = thread.get()
    ...
    def update_default_project(
        ...
        **kwargs
        ...
        """Update the Default Project  # noqa: E501

        To update a project, send a PUT request to `/v2/projects/default`. All of the following attributes must be sent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_default_project(unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.update_default_project_endpoint.call_with_http_info(**kwargs)
    ...
    def update_project(
        ...
        **kwargs
        ...
        To update a project, send a PUT request to `/v2/projects/$PROJECT_ID`. All of the following attributes must be sent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_project(project_id, unknown_base_type, async_req=True)
        >>> result = thread.get()
