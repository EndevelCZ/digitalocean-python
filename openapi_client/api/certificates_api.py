...
class CertificatesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_certificates_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse201,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/certificates',
                'operation_id': 'create_certificates',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_certificate_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v2/certificates/{certificate_id}',
    ...
    def create_certificates(
        ...
        **kwargs
        ...
        """Create a New Certificate  # noqa: E501
        ...
        >>> thread = api.create_certificates(unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.create_certificates_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_certificate(
        ...
        **kwargs
        ...
        To delete a specific certificate, send a DELETE request to `/v2/certificates/$CERTIFICATE_ID`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_certificate(certificate_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_certificate(
        ...
        **kwargs
        ...
        """Retrieve an Existing Certificate  # noqa: E501

        To show information about an existing certificate, send a GET request to `/v2/certificates/$CERTIFICATE_ID`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_certificate(certificate_id, async_req=True)
        >>> result = thread.get()
    ...
    def list_certificates(
        ...
        **kwargs
        ...
        To list all of the certificates available on your account, send a GET request to `/v2/certificates`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
