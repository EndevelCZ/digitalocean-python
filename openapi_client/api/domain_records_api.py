...
class DomainRecordsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_domain_record_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/domains/{domain_name}/records',
                'operation_id': 'create_domain_record',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_domain_record_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/domains/{domain_name}/records/{domain_record_id}',
                'operation_id': 'delete_domain_record',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_domain_record_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/domains/{domain_name}/records/{domain_record_id}',
                'operation_id': 'get_domain_record',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_all_domain_records_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/domains/{domain_name}/records',
                'operation_id': 'list_all_domain_records',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_update_domain_record_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/domains/{domain_name}/records/{domain_record_id}',
                'operation_id': 'patch_update_domain_record',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.update_domain_record_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/domains/{domain_name}/records/{domain_record_id}',
                'operation_id': 'update_domain_record',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def create_domain_record(
        ...
        **kwargs
        ...
        """Create a New Domain Record  # noqa: E501

        To create a new record to a domain, send a POST request to `/v2/domains/$DOMAIN_NAME/records`.  The request must include all of the required fields for the domain record type being added.  See the [attribute table](#tag/Domain-Records) for details regarding record types and their respective required attributes.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_domain_record(domain_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['domain_name'] = \
            domain_name
        return self.create_domain_record_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_domain_record(
        ...
        **kwargs
        ...
        """Delete a Domain Record  # noqa: E501

        To delete a record for a domain, send a DELETE request to `/v2/domains/$DOMAIN_NAME/records/$DOMAIN_RECORD_ID`.  The record will be deleted and the response status will be a 204. This indicates a successful request with no body returned.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_domain_record(domain_name, domain_record_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['domain_name'] = \
            domain_name
        kwargs['domain_record_id'] = \
            domain_record_id
        return self.delete_domain_record_endpoint.call_with_http_info(**kwargs)
    ...
    def get_domain_record(
        ...
        **kwargs
        ...
        """Retrieve an Existing Domain Record  # noqa: E501

        To retrieve a specific domain record, send a GET request to `/v2/domains/$DOMAIN_NAME/records/$RECORD_ID`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_domain_record(domain_name, domain_record_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['domain_record_id'] = \
            domain_record_id
        return self.get_domain_record_endpoint.call_with_http_info(**kwargs)

    def list_all_domain_records(
        self,
        domain_name,
        **kwargs
    ):
        """List All Domain Records  # noqa: E501
        ...
        >>> thread = api.list_all_domain_records(domain_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['domain_name'] = \
            domain_name
        return self.list_all_domain_records_endpoint.call_with_http_info(**kwargs)

    def patch_update_domain_record(
        self,
        domain_name,
        domain_record_id,
        **kwargs
    ):
        """Update a Domain Record  # noqa: E501

        To update an existing record, send a PATCH request to `/v2/domains/$DOMAIN_NAME/records/$DOMAIN_RECORD_ID`. Any attribute valid for the record type can be set to a new value for the record.  See the [attribute table](#tag/Domain-Records) for details regarding record types and their respective attributes.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_update_domain_record(domain_name, domain_record_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            domain_record (DomainRecord): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['domain_record_id'] = \
            domain_record_id
        return self.patch_update_domain_record_endpoint.call_with_http_info(**kwargs)
    ...
    def update_domain_record(
        ...
        **kwargs
        ...
        To update an existing record, send a PUT request to `/v2/domains/$DOMAIN_NAME/records/$DOMAIN_RECORD_ID`. Any attribute valid for the record type can be set to a new value for the record.  See the [attribute table](#tag/Domain-Records) for details regarding record types and their respective attributes.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_domain_record(domain_name, domain_record_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['domain_record_id'] = \
            domain_record_id
        return self.update_domain_record_endpoint.call_with_http_info(**kwargs)
