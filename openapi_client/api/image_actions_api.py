...
class ImageActionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_image_action_endpoint = _Endpoint(
            settings={
                'response_type': (Action,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/images/{image_id}/actions/{action_id}',
        ...
        self.list_image_actions_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/images/{image_id}/actions',
        ...
        self.post_image_action_endpoint = _Endpoint(
            settings={
                'response_type': (Action,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/images/{image_id}/actions',
                'operation_id': 'post_image_action',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_image_action(
        ...
        **kwargs
        ...
        """Retrieve an Existing Action  # noqa: E501

        To retrieve the status of an image action, send a GET request to `/v2/images/$IMAGE_ID/actions/$IMAGE_ACTION_ID`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_image_action(image_id, action_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['action_id'] = \
            action_id
        return self.get_image_action_endpoint.call_with_http_info(**kwargs)

    def list_image_actions(
        self,
        image_id,
        **kwargs
    ):
        """List All Actions for an Image  # noqa: E501

        To retrieve all actions that have been executed on an image, send a GET request to `/v2/images/$IMAGE_ID/actions`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_image_actions(image_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['image_id'] = \
            image_id
        return self.list_image_actions_endpoint.call_with_http_info(**kwargs)
    ...
    def post_image_action(
        ...
        **kwargs
        ...
        kwargs['image_id'] = \
            image_id
        return self.post_image_action_endpoint.call_with_http_info(**kwargs)
