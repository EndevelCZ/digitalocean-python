...
class CDNEndpointsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_cdn_endpoint_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/cdn/endpoints',
                'operation_id': 'create_cdn_endpoint',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_cdn_endpoint_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/cdn/endpoints/{cdn_id}',
                'operation_id': 'delete_cdn_endpoint',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_cdn_endpoint_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
        ...
        self.list_cdn_endpoints_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/cdn/endpoints',
                'operation_id': 'list_cdn_endpoints',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.purge_cdn_cache_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/cdn/endpoints/{cdn_id}/cache',
                'operation_id': 'purge_cdn_cache',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.update_cdn_endpoint_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/cdn/endpoints/{cdn_id}',
                'operation_id': 'update_cdn_endpoint',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def create_cdn_endpoint(
        ...
        **kwargs
        ...
        kwargs['cdn_endpoint'] = \
            cdn_endpoint
        return self.create_cdn_endpoint_endpoint.call_with_http_info(**kwargs)

    def delete_cdn_endpoint(
        self,
        cdn_id,
        **kwargs
    ):
        """Delete a CDN Endpoint  # noqa: E501

        To delete a specific CDN endpoint, send a DELETE request to `/v2/cdn/endpoints/$ENDPOINT_ID`.  A status of 204 will be given. This indicates that the request was processed successfully, but that no response body is needed.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_cdn_endpoint(cdn_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cdn_id'] = \
            cdn_id
        return self.delete_cdn_endpoint_endpoint.call_with_http_info(**kwargs)

    def get_cdn_endpoint(
        self,
        cdn_id,
        **kwargs
    ):
        """Retrieve an Existing CDN Endpoint  # noqa: E501

        To show information about an existing CDN endpoint, send a GET request to `/v2/cdn/endpoints/$ENDPOINT_ID`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_cdn_endpoint(cdn_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cdn_id'] = \
            cdn_id
        return self.get_cdn_endpoint_endpoint.call_with_http_info(**kwargs)

    def list_cdn_endpoints(
        self,
        **kwargs
    ):
        """List All CDN Endpoints  # noqa: E501

        To list all of the CDN endpoints available on your account, send a GET request to `/v2/cdn/endpoints`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_cdn_endpoints(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_cdn_endpoints_endpoint.call_with_http_info(**kwargs)
    ...
    def purge_cdn_cache(
        ...
        **kwargs
        ...
        """Purge the Cache for an Existing CDN Endpoint  # noqa: E501

        To purge cached content from a CDN endpoint, send a DELETE request to `/v2/cdn/endpoints/$ENDPOINT_ID/cache`. The body of the request should include a `files` attribute containing a list of cached file paths to be purged. A path may be for a single file or may contain a wildcard (`*`) to recursively purge all files under a directory. When only a wildcard is provided, all cached files will be purged.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.purge_cdn_cache(cdn_id, purge_cache, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['purge_cache'] = \
            purge_cache
        return self.purge_cdn_cache_endpoint.call_with_http_info(**kwargs)

    def update_cdn_endpoint(
        self,
        cdn_id,
        update_endpoint,
        **kwargs
    ):
        """Update a CDN Endpoint  # noqa: E501

        To update the TTL, certificate ID, or the FQDN of the custom subdomain for an existing CDN endpoint, send a PUT request to `/v2/cdn/endpoints/$ENDPOINT_ID`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_cdn_endpoint(cdn_id, update_endpoint, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['update_endpoint'] = \
            update_endpoint
        return self.update_cdn_endpoint_endpoint.call_with_http_info(**kwargs)
