...
class FloatingIPActionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_floating_ip_action_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/floating_ips/{floating_ip}/actions/{action_id}',
        ...
        self.list_floating_ip_actions_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/floating_ips/{floating_ip}/actions',
        ...
        self.post_floating_ip_action_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/floating_ips/{floating_ip}/actions',
                'operation_id': 'post_floating_ip_action',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_floating_ip_action(
        self,
        floating_ip,
        action_id,
        **kwargs
    ):
        """Retrieve an Existing Floating IP Action  # noqa: E501

        To retrieve the status of a floating IP action, send a GET request to `/v2/floating_ips/$FLOATING_IP/actions/$ACTION_ID`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_floating_ip_action(floating_ip, action_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['action_id'] = \
            action_id
        return self.get_floating_ip_action_endpoint.call_with_http_info(**kwargs)

    def list_floating_ip_actions(
        self,
        floating_ip,
        **kwargs
    ):
        """List All Actions for a Floating IP  # noqa: E501

        To retrieve all actions that have been executed on a floating IP, send a GET request to `/v2/floating_ips/$FLOATING_IP/actions`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_floating_ip_actions(floating_ip, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['floating_ip'] = \
            floating_ip
        return self.list_floating_ip_actions_endpoint.call_with_http_info(**kwargs)

    def post_floating_ip_action(
        self,
        floating_ip,
        **kwargs
    ):
        """Initiate a Floating IP Action  # noqa: E501

        To initiate an action on a floating IP send a POST request to `/v2/floating_ips/$FLOATING_IP/actions`. In the JSON body to the request, set the `type` attribute to on of the supported action types:  | Action     | Details |------------|-------- | `assign`   | Assigns a floating IP to a Droplet | `unassign` | Unassign a floating IP from a Droplet   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_floating_ip_action(floating_ip, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            unknown_base_type (UNKNOWN_BASE_TYPE): The `type` attribute set in the request body will specify the action that will be taken on the floating IP. . [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['floating_ip'] = \
            floating_ip
        return self.post_floating_ip_action_endpoint.call_with_http_info(**kwargs)
