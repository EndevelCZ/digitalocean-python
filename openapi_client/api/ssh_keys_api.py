...
class SSHKeysApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_ssh_key_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/account/keys',
        ...
        self.destroy_ssh_key_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/account/keys/{ssh_key_identifier}',
                'operation_id': 'destroy_ssh_key',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_ssh_key_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
        ...
        self.list_all_keys_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
        ...
        self.update_ssh_key_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
    ...
    def create_ssh_key(
        ...
        **kwargs
        ...
        To add a new SSH public key to your DigitalOcean account, send a POST request to `/v2/account/keys`. Set the `name` attribute to the name you wish to use and the `public_key` attribute to the full public key you are adding.  # noqa: E501
        ...
        kwargs['ssh_key'] = \
            ssh_key
        return self.create_ssh_key_endpoint.call_with_http_info(**kwargs)
    ...
    def destroy_ssh_key(
        ...
        **kwargs
        ...
        To destroy a public SSH key that you have in your account, send a DELETE request to `/v2/account/keys/$KEY_ID` or `/v2/account/keys/$KEY_FINGERPRINT`. A 204 status will be returned, indicating that the action was successful and that the response body is empty.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.destroy_ssh_key(ssh_key_identifier, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['ssh_key_identifier'] = \
            ssh_key_identifier
        return self.destroy_ssh_key_endpoint.call_with_http_info(**kwargs)
    ...
    def get_ssh_key(
        ...
        **kwargs
        ...
        """Retrieve an Existing SSH Key  # noqa: E501

        To get information about a key, send a GET request to `/v2/account/keys/$KEY_ID` or `/v2/account/keys/$KEY_FINGERPRINT`. The response will be a JSON object with the key `ssh_key` and value an ssh_key object which contains the standard ssh_key attributes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_ssh_key(ssh_key_identifier, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['ssh_key_identifier'] = \
            ssh_key_identifier
        return self.get_ssh_key_endpoint.call_with_http_info(**kwargs)
    ...
    def list_all_keys(
        ...
        **kwargs
        ...
        To list all of the keys in your account, send a GET request to `/v2/account/keys`. The response will be a JSON object with a key set to `ssh_keys`. The value of this will be an array of ssh_key objects, each of which contains the standard ssh_key attributes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_all_keys(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_all_keys_endpoint.call_with_http_info(**kwargs)
    ...
    def update_ssh_key(
        ...
        **kwargs
        ...
        """Update an SSH Key's Name  # noqa: E501

        To update the name of an SSH key, send a PUT request to either `/v2/account/keys/$SSH_KEY_ID` or `/v2/account/keys/$SSH_KEY_FINGERPRINT`. Set the `name` attribute to the new name you want to use.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_ssh_key(ssh_key_identifier, inline_object, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['inline_object'] = \
            inline_object
        return self.update_ssh_key_endpoint.call_with_http_info(**kwargs)
