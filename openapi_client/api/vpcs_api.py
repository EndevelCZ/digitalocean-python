...
class VPCsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_vpc_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2016,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/vpcs',
        ...
        self.delete_vpc_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/vpcs/{vpc_id}',
        ...
        self.get_vpc_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2016,),
                'auth': [
                    'bearer_auth'
        ...
        self.list_vpc_members_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/vpcs/{vpc_id}/members',
                'operation_id': 'list_vpc_members',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_vpcs_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
        ...
        self.patch_vpc_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2016,),
                'auth': [
                    'bearer_auth'
        ...
        self.update_vpc_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2016,),
                'auth': [
                    'bearer_auth'
    ...
    def create_vpc(
        ...
        **kwargs
        ...
        """Create a New VPC  # noqa: E501

        To create a VPC, send a POST request to `/v2/vpcs` specifying the attributes in the table below in the JSON body.  **Note:** If you do not currently have a VPC network in a specific datacenter region, the first one that you create will be set as the default for that region. The default VPC for a region cannot be changed or deleted.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_vpc(unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.create_vpc_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_vpc(
        ...
        **kwargs
        ...
        kwargs['vpc_id'] = \
            vpc_id
        return self.delete_vpc_endpoint.call_with_http_info(**kwargs)
    ...
    def get_vpc(
        ...
        **kwargs
        ...
        """Retrieve an Existing VPC  # noqa: E501

        To show information about an existing VPC, send a GET request to `/v2/vpcs/$VPC_ID`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_vpc(vpc_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['vpc_id'] = \
            vpc_id
        return self.get_vpc_endpoint.call_with_http_info(**kwargs)

    def list_vpc_members(
        self,
        vpc_id,
        **kwargs
    ):
        """List the Member Resources of a VPC  # noqa: E501

        To list all of the resources that are members of a VPC, send a GET request to `/v2/vpcs/$VPC_ID/members`.  To only list resources of a specific type that are members of the VPC, included a `resource_type` query parameter. For example, to only list Droplets in the VPC, send a GET request to `/v2/vpcs/$VPC_ID/members?resource_type=droplet`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_vpc_members(vpc_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['vpc_id'] = \
            vpc_id
        return self.list_vpc_members_endpoint.call_with_http_info(**kwargs)

    def list_vpcs(
        self,
        **kwargs
    ):
        """List All VPCs  # noqa: E501

        To list all of the VPCs on your account, send a GET request to `/v2/vpcs`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_vpcs_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_vpc(
        ...
        **kwargs
        ...
        """Partially Update a VPC  # noqa: E501

        To update a subset of information about a VPC, send a PATCH request to `/v2/vpcs/$VPC_ID`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_vpc(vpc_id, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.patch_vpc_endpoint.call_with_http_info(**kwargs)
    ...
    def update_vpc(
        ...
        **kwargs
        ...
        """Update a VPC  # noqa: E501

        To update information about a VPC, send a PUT request to `/v2/vpcs/$VPC_ID`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_vpc(vpc_id, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.update_vpc_endpoint.call_with_http_info(**kwargs)
