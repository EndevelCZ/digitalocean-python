...
class FloatingIPsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_floating_ip_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse202,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/floating_ips',
        ...
        self.delete_floating_ip_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/floating_ips/{floating_ip}',
        ...
        self.get_floating_ip_endpoint = _Endpoint(
            settings={
        ...
        self.list_floating_ips_endpoint = _Endpoint(
            settings={
    ...
    def create_floating_ip(
        ...
        **kwargs
        ...
        """Create a New Floating IP  # noqa: E501

        On creation, a floating IP must be either assigned to a Droplet or reserved to a region. * To create a new floating IP assigned to a Droplet, send a POST   request to `/v2/floating_ips` with the `droplet_id` attribute.  * To create a new floating IP reserved to a region, send a POST request to   `/v2/floating_ips` with the `region` attribute.  **Note**:  In addition to the standard rate limiting, only 12 floating IPs may be created per 60 seconds.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_floating_ip(floating_ip_create, async_req=True)
        >>> result = thread.get()

        Args:
            floating_ip_create (FloatingIpCreate):
        ...
        kwargs['floating_ip_create'] = \
            floating_ip_create
        return self.create_floating_ip_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_floating_ip(
        ...
        **kwargs
        ...
        """Delete a Floating IPs  # noqa: E501

        To delete a floating IP and remove it from your account, send a DELETE request to `/v2/floating_ips/$FLOATING_IP_ADDR`.  A successful request will receive a 204 status code with no body in response. This indicates that the request was processed successfully.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_floating_ip(floating_ip, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['floating_ip'] = \
            floating_ip
        return self.delete_floating_ip_endpoint.call_with_http_info(**kwargs)
    ...
    def get_floating_ip(
        ...
        **kwargs
        ...
        """Retrieve an Existing Floating IP  # noqa: E501

        To show information about a floating IP, send a GET request to `/v2/floating_ips/$FLOATING_IP_ADDR`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_floating_ip(floating_ip, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['floating_ip'] = \
            floating_ip
        return self.get_floating_ip_endpoint.call_with_http_info(**kwargs)

    def list_floating_ips(
        self,
        **kwargs
    ):
        """List All Floating IPs  # noqa: E501

        To list all of the floating IPs available on your account, send a GET request to `/v2/floating_ips`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_floating_ips_endpoint.call_with_http_info(**kwargs)
