...
class ActionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_action_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v2/actions/{action_id}',
        ...
        self.list_all_actions_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/actions',
                'operation_id': 'list_all_actions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_action(
        ...
        **kwargs
        ...
        To retrieve a specific action object, send a GET request to `/v2/actions/$ACTION_ID`.  # noqa: E501
    ...
    def list_all_actions(
        ...
        **kwargs
        ...
        """List All Actions  # noqa: E501

        This will be the entire list of actions taken on your account, so it will be quite large. As with any large collection returned by the API, the results will be paginated with only 20 on each page by default.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_all_actions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_all_actions_endpoint.call_with_http_info(**kwargs)
