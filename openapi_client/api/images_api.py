...
class ImagesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_image_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v2/images/{image_id}',
        ...
        self.get_images_list_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
    ...
    def create_custom_image(
        ...
        **kwargs
        ...
        """Create a Custom Image  # noqa: E501

        To create a new custom image, send a POST request to /v2/images. The body must contain a url attribute pointing to a Linux virtual machine image to be imported into DigitalOcean. The image must be in the raw, qcow2, vhdx, vdi, or vmdk format. It may be compressed using gzip or bzip2 and must be smaller than 100 GB after  being decompressed.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_custom_image(image_new_custom, async_req=True)
        >>> result = thread.get()

        Args:
            image_new_custom (ImageNewCustom):
    ...
    def delete_image(
        ...
        **kwargs
        ...
        To delete a snapshot or custom image, send a `DELETE` request to `/v2/images/$IMAGE_ID`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_image(
        ...
        **kwargs
        ...
        """Retrieve an Existing Image  # noqa: E501

        To retrieve information about an image, send a `GET` request to `/v2/images/$IDENTIFIER`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_images_list(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_images_list_endpoint.call_with_http_info(**kwargs)
    ...
    def update_image(
        ...
        **kwargs
        ...
        To update an image, send a `PUT` request to `/v2/images/$IMAGE_ID`. Set the `name` attribute to the new value you would like to use. For custom images, the `description` and `distribution` attributes may also be updated.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_image(image_id, image_update, async_req=True)
        >>> result = thread.get()
