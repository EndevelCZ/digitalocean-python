...
class ProjectResourcesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.assign_default_project_resources_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2006,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/projects/default/resources',
                'operation_id': 'assign_default_project_resources',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.assign_project_resources_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2006,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/projects/{project_id}/resources',
                'operation_id': 'assign_project_resources',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.list_default_project_resources_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v2/projects/default/resources',
                'operation_id': 'list_default_project_resources',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_project_resources_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
    ...
    def assign_default_project_resources(
        self,
        project_assignment,
        **kwargs
    ):
        """Assign Resources to Default Project  # noqa: E501

        To assign resources to your default project, send a POST request to `/v2/projects/default/resources`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.assign_default_project_resources(project_assignment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_assignment'] = \
            project_assignment
        return self.assign_default_project_resources_endpoint.call_with_http_info(**kwargs)
    ...
    def assign_project_resources(
        ...
        **kwargs
        ...
        """Assign Resources to a Project  # noqa: E501

        To assign resources to a project, send a POST request to `/v2/projects/$PROJECT_ID/resources`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.assign_project_resources(project_id, project_assignment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_assignment'] = \
            project_assignment
        return self.assign_project_resources_endpoint.call_with_http_info(**kwargs)

    def list_default_project_resources(
        self,
        **kwargs
    ):
        """List Default Project Resources  # noqa: E501

        To list all your resources in your default project, send a GET request to `/v2/projects/default/resources`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_default_project_resources(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_default_project_resources_endpoint.call_with_http_info(**kwargs)
    ...
    def list_project_resources(
        ...
        **kwargs
        ...
        """List Project Resources  # noqa: E501

        To list all your resources in a project, send a GET request to `/v2/projects/$PROJECT_ID/resources`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_project_resources(project_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_id'] = \
            project_id
        return self.list_project_resources_endpoint.call_with_http_info(**kwargs)
