...
class SizesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_all_sizes_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/sizes',
                'operation_id': 'list_all_sizes',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_all_sizes(
        ...
        **kwargs
        ...
        """List All Droplet Sizes  # noqa: E501

        To list all of available Droplet sizes, send a GET request to `/v2/sizes`. The response will be a JSON object with a key called `sizes`. The value of this will be an array of `size` objects each of which contain the standard size attributes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_all_sizes(async_req=True)
        >>> result = thread.get()
        ...
        return self.list_all_sizes_endpoint.call_with_http_info(**kwargs)
