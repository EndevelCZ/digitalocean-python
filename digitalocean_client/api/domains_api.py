...
class DomainsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_domain_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v2/domains/{domain_name}',
        ...
        self.get_domain_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
        ...
        self.list_all_domains_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
    ...
    def create_domain(
        ...
        **kwargs
        ...
        To create a new domain, send a POST request to `/v2/domains`. Set the \"name\" attribute to the domain name you are adding. Optionally, you may set the \"ip_address\" attribute, and an A record will be automatically created pointing to the apex domain.   # noqa: E501
    ...
    def delete_domain(
        ...
        **kwargs
        ...
        To delete a domain, send a DELETE request to `/v2/domains/$DOMAIN_NAME`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_domain(
        ...
        **kwargs
        ...
        """Retrieve an Existing Domain  # noqa: E501

        To get details about a specific domain, send a GET request to `/v2/domains/$DOMAIN_NAME`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['domain_name'] = \
            domain_name
        return self.get_domain_endpoint.call_with_http_info(**kwargs)
    ...
    def list_all_domains(
        ...
        **kwargs
        ...
        To retrieve a list of all of the domains in your account, send a GET request to `/v2/domains`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_all_domains(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_all_domains_endpoint.call_with_http_info(**kwargs)
