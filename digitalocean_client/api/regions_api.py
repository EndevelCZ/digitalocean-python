...
class RegionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_all_regions_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/regions',
                'operation_id': 'list_all_regions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_all_regions(
        ...
        **kwargs
        ...
        """List All Data Center Regions  # noqa: E501

        To list all of the regions that are available, send a GET request to `/v2/regions`. The response will be a JSON object with a key called `regions`. The value of this will be an array of `region` objects, each of which will contain the standard region attributes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_all_regions(async_req=True)
        >>> result = thread.get()
        ...
        return self.list_all_regions_endpoint.call_with_http_info(**kwargs)
