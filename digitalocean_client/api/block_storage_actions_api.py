...
class BlockStorageActionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_volume_action_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/volumes/{volume_id}/actions/{action_id}',
        ...
        self.list_all_volume_actions_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/volumes/{volume_id}/actions',
                'operation_id': 'list_all_volume_actions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.post_volume_action_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/volumes/{volume_id}/actions',
                'operation_id': 'post_volume_action_by_id',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.post_volume_action_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/volumes/actions',
                'operation_id': 'post_volume_action_by_name',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_volume_action(
        ...
        **kwargs
        ...
        """Retrieve an Existing Volume Action  # noqa: E501

        To retrieve the status of a volume action, send a GET request to `/v2/volumes/$VOLUME_ID/actions/$ACTION_ID`.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_volume_action(volume_id, action_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['action_id'] = \
            action_id
        return self.get_volume_action_endpoint.call_with_http_info(**kwargs)

    def list_all_volume_actions(
        self,
        volume_id,
        **kwargs
    ):
        """List All Actions for a Volume  # noqa: E501

        To retrieve all actions that have been executed on a volume, send a GET request to `/v2/volumes/$VOLUME_ID/actions`.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_all_volume_actions(volume_id, async_req=True)
        >>> result = thread.get()
    ...
    def post_volume_action_by_id(
        ...
        **kwargs
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.post_volume_action_by_id_endpoint.call_with_http_info(**kwargs)

    def post_volume_action_by_name(
        self,
        unknown_base_type,
        **kwargs
    ):
        """Initiate A Block Storage Action By Volume Name  # noqa: E501

        To initiate an action on a block storage volume by Id, send a POST request to `~/v2/volumes/actions`. The body should contain the appropriate attributes for the respective action.  ## Attach a Block Storage Volume to a Droplet  | Attribute   | Details                                                             | | ----------- | ------------------------------------------------------------------- | | type        | This must be `attach`                                               | | volume_name | The name of the block storage volume                                | | droplet_id  | Set to the Droplet's ID                                             | | region      | Set to the slug representing the region where the volume is located |  Each volume may only be attached to a single Droplet. However, up to five volumes may be attached to a Droplet at a time. Pre-formatted volumes will be automatically mounted to Ubuntu, Debian, Fedora, Fedora Atomic, and CentOS Droplets created on or after April 26, 2018 when attached. On older Droplets, [additional configuration](https://www.digitalocean.com/community/tutorials/how-to-partition-and-format-digitalocean-block-storage-volumes-in-linux#mounting-the-filesystems) is required.  ## Remove a Block Storage Volume from a Droplet  | Attribute   | Details                                                             | | ----------- | ------------------------------------------------------------------- | | type        | This must be `detach`                                               | | volume_name | The name of the block storage volume                                | | droplet_id  | Set to the Droplet's ID                                             | | region      | Set to the slug representing the region where the volume is located |   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_volume_action_by_name(unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.post_volume_action_by_name_endpoint.call_with_http_info(**kwargs)
