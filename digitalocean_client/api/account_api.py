...
class AccountApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_user_information_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/account',
    ...
    def get_user_information(
        ...
        **kwargs
        ...
        To show information about the current user account, send a GET request to `/v2/account`.  # noqa: E501
        ...
        return self.get_user_information_endpoint.call_with_http_info(**kwargs)
