...
class TagsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_new_tag_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/tags',
                'operation_id': 'create_new_tag',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.list_all_tags_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
        ...
        self.tag_resource_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/tags/{tag_id}/resources',
                'operation_id': 'tag_resource',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.untag_resource_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
    ...
    def create_new_tag(
        ...
        **kwargs
        ...
        To create a tag you can send a POST request to `/v2/tags` with a `name` attribute.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_new_tag(tag, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['tag'] = \
            tag
        return self.create_new_tag_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_tag(
        ...
        **kwargs
        ...
        A tag can be deleted by sending a `DELETE` request to `/v2/tags/$TAG_NAME`. Deleting a tag also untags all the resources that have previously been tagged by the Tag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_tag(
        ...
        **kwargs
        ...
        To retrieve an individual tag, you can send a `GET` request to `/v2/tags/$TAG_NAME`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_all_tags(
        ...
        **kwargs
        ...
        To list all of your tags, you can send a GET request to `/v2/tags`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_all_tags(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_all_tags_endpoint.call_with_http_info(**kwargs)
    ...
    def tag_resource(
        ...
        **kwargs
        ...
        """Tag a Resource  # noqa: E501

        Resources can be tagged by sending a POST request to `/v2/tags/$TAG_NAME/resources` with an array of json objects containing `resource_id` and `resource_type` attributes. Currently only tagging of Droplets, Images, Volumes, and Volume Snapshots is supported. `resource_id` is expected to be the Droplet's id, Image's id, or Volume/Volume Snapshot's UUID attribute as a string, and `resource_type` is expected to be the string `droplet`, `image`, `volume` or `volume_snapshot`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.tag_resource(tag_id, tag_resource, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['tag_resource'] = \
            tag_resource
        return self.tag_resource_endpoint.call_with_http_info(**kwargs)
    ...
    def untag_resource(
        ...
        **kwargs
        ...
        >>> thread = api.untag_resource(tag_id, tag_resource, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['tag_resource'] = \
            tag_resource
        return self.untag_resource_endpoint.call_with_http_info(**kwargs)
