...
class ContainerRegistryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_repository_manifest_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/{registry_name}/{repository_name}/digests/{manifest_digest}',
                'operation_id': 'delete_repository_manifest',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.delete_repository_tag_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/{registry_name}/{repository_name}/tags/{repository_tag}',
                'operation_id': 'delete_repository_tag',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_docker_credentials_endpoint = _Endpoint(
            settings={
                'response_type': (DockerCredentials,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/docker-credentials',
                'operation_id': 'get_docker_credentials',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_garbage_collection_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2007,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/{registry_name}/garbage-collection',
                'operation_id': 'get_garbage_collection',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_registry_options_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2009,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/options',
                'operation_id': 'get_registry_options',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_registry_subscription_endpoint = _Endpoint(
            settings={
                'response_type': (Subscription,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/subscription',
                'operation_id': 'get_registry_subscription',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_garbage_collections_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2008,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/{registry_name}/garbage-collections',
                'operation_id': 'list_garbage_collections',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_registry_repositories_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/{registry_name}',
                'operation_id': 'list_registry_repositories',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_repository_tags_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/{registry_name}/{repository_name}/tags',
        ...
        self.post_registry_subscription_endpoint = _Endpoint(
            settings={
                'response_type': (Subscription,),
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/registry/subscription',
                'operation_id': 'post_registry_subscription',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.run_garbage_collection_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2007,),
                'auth': [
                    'bearer_auth'
        ...
        self.update_garbage_collection_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2007,),
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/{registry_name}/garbage-collection/{garbage_collection_uuid}',
                'operation_id': 'update_garbage_collection',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'registry_name': 'path',
                    'garbage_collection_uuid': 'path',
                    'update_registry': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.validate_registry_name_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/registry/validate-name',
                'operation_id': 'validate_registry_name',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_registry(
        ...
        **kwargs
        ...
        To create your container registry, send a POST request to `/v2/registry`.  The `name` becomes part of the URL for images stored in the registry. For example, if your registry is called `example`, an image in it will have the URL `registry.digitalocean.com/example/image:tag`.   # noqa: E501
    ...
    def delete_registry(
        ...
        **kwargs
        ...
        To delete your container registry, destroying all container image data stored in it, send a DELETE request to `/v2/registry`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_registry(async_req=True)
        >>> result = thread.get()
    ...
    def delete_repository_manifest(
        ...
        **kwargs
        ...
        """Delete Container Registry Repository Manifest  # noqa: E501
        ...
        >>> thread = api.delete_repository_manifest(registry_name, repository_name, manifest_digest, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['registry_name'] = \
            registry_name
        kwargs['repository_name'] = \
            repository_name
        kwargs['manifest_digest'] = \
            manifest_digest
        return self.delete_repository_manifest_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_repository_tag(
        ...
        **kwargs
        ...
        """Delete Container Registry Repository Tag  # noqa: E501
        ...
        >>> thread = api.delete_repository_tag(registry_name, repository_name, repository_tag, async_req=True)
        >>> result = thread.get()
    ...
    def get_docker_credentials(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_docker_credentials_endpoint.call_with_http_info(**kwargs)
    ...
    def get_garbage_collection(
        ...
        **kwargs
        ...
        """Get Active Garbage Collection  # noqa: E501

        To get information about the currently-active garbage collection for a registry, send a GET request to `/v2/registry/$REGISTRY_NAME/garbage-collection`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_garbage_collection(registry_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['registry_name'] = \
            registry_name
        return self.get_garbage_collection_endpoint.call_with_http_info(**kwargs)

    def get_registry(
        self,
        **kwargs
    ):
        """Get Container Registry Information  # noqa: E501

        To get information about your container registry, send a GET request to `/v2/registry`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_registry(async_req=True)
        >>> result = thread.get()
    ...
    def get_registry_options(
        self,
        **kwargs
    ):
        """List Available Subscription Tiers  # noqa: E501

        There are multiple subscription tiers available for container registry. Each tier allows a different number of image repositories to be created in your registry, and has a different amount of storage and transfer included. To list the available subscription tiers, send a GET request to `/v2/registry/options`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_registry_options(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_registry_options_endpoint.call_with_http_info(**kwargs)

    def get_registry_subscription(
        self,
        **kwargs
    ):
        """Get Subscription Information  # noqa: E501

        A subscription is automatically created when you configure your container registry. To get information about your subscription, send a GET request to `/v2/registry/subscription`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_registry_subscription(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_registry_subscription_endpoint.call_with_http_info(**kwargs)
    ...
    def list_garbage_collections(
        ...
        **kwargs
        ...
        """List Garbage Collections  # noqa: E501

        To get information about past garbage collections for a registry, send a GET request to `/v2/registry/$REGISTRY_NAME/garbage-collections`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_garbage_collections(registry_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['registry_name'] = \
            registry_name
        return self.list_garbage_collections_endpoint.call_with_http_info(**kwargs)
    ...
    def list_registry_repositories(
        ...
        **kwargs
        ...
        """List All Container Registry Repositories  # noqa: E501

        To list all repositories in your container registry, send a GET request to `/v2/registry/$REGISTRY_NAME/repositories`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_registry_repositories(registry_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['registry_name'] = \
            registry_name
        return self.list_registry_repositories_endpoint.call_with_http_info(**kwargs)
    ...
    def list_repository_tags(
        ...
        **kwargs
        ...
        kwargs['repository_name'] = \
            repository_name
        return self.list_repository_tags_endpoint.call_with_http_info(**kwargs)

    def post_registry_subscription(
        self,
        **kwargs
    ):
        """Update Subscription Tier  # noqa: E501

        After creating your registry, you can switch to a different subscription tier to better suit your needs. To do this, send a POST request to `/v2/registry/subscription`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_registry_subscription(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.post_registry_subscription_endpoint.call_with_http_info(**kwargs)
    ...
    def run_garbage_collection(
        ...
        **kwargs
        ...
        kwargs['registry_name'] = \
            registry_name
        return self.run_garbage_collection_endpoint.call_with_http_info(**kwargs)
    ...
    def update_garbage_collection(
        ...
        **kwargs
        ...
        """Update Garbage Collection  # noqa: E501

        To cancel the currently-active garbage collection for a registry, send a PUT request to `/v2/registry/$REGISTRY_NAME/garbage-collection/$GC_UUID` and specify one or more of the attributes below.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_garbage_collection(registry_name, garbage_collection_uuid, update_registry, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['registry_name'] = \
            registry_name
        kwargs['garbage_collection_uuid'] = \
            garbage_collection_uuid
        kwargs['update_registry'] = \
            update_registry
        return self.update_garbage_collection_endpoint.call_with_http_info(**kwargs)

    def validate_registry_name(
        self,
        validate_registry,
        **kwargs
    ):
        """Validate a Container Registry Name  # noqa: E501

        To validate that a container registry name is available for use, send a POST request to `/v2/registry/validate-name`.  If the name is both formatted correctly and available, the response code will be 204 and contain no body. If the name is already in use, the response will be a 409 Conflict.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.validate_registry_name(validate_registry, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['validate_registry'] = \
            validate_registry
        return self.validate_registry_name_endpoint.call_with_http_info(**kwargs)
