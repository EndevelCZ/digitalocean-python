...
class LoadBalancersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_load_balancer_droplets_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/load_balancers/{lb_id}/droplets',
                'operation_id': 'add_load_balancer_droplets',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.add_load_balancer_forwarding_rules_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ],
                'endpoint_path': '/v2/load_balancers/{lb_id}/forwarding_rules',
                'operation_id': 'add_load_balancer_forwarding_rules',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.create_load_balancer_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v2/load_balancers',
        ...
        self.delete_load_balancer_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v2/load_balancers/{lb_id}',
        ...
        self.list_all_load_balancers_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'bearer_auth'
        ...
        self.remove_load_balancer_droplets_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/load_balancers/{lb_id}/droplets',
                'operation_id': 'remove_load_balancer_droplets',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.remove_load_balancer_forwarding_rules_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer_auth'
                ...
                'endpoint_path': '/v2/load_balancers/{lb_id}/forwarding_rules',
                'operation_id': 'remove_load_balancer_forwarding_rules',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def add_load_balancer_droplets(
        self,
        lb_id,
        unknown_base_type,
        **kwargs
    ):
        """Add Droplets to a Load Balancer  # noqa: E501
        ...
        >>> thread = api.add_load_balancer_droplets(lb_id, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.add_load_balancer_droplets_endpoint.call_with_http_info(**kwargs)

    def add_load_balancer_forwarding_rules(
        self,
        lb_id,
        unknown_base_type,
        **kwargs
    ):
        """Add Forwarding Rules to a Load Balancer  # noqa: E501
        ...
        >>> thread = api.add_load_balancer_forwarding_rules(lb_id, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.add_load_balancer_forwarding_rules_endpoint.call_with_http_info(**kwargs)
    ...
    def create_load_balancer(
        ...
        **kwargs
        ...
        """Create a New Load Balancer  # noqa: E501

        To create a new load balancer instance, send a POST request to `/v2/load_balancers`.  You can specify the Droplets that will sit behind the load balancer using one of two methods:  * Set `droplet_ids` to a list of specific Droplet IDs. * Set `tag` to the name of a tag. All Droplets with this tag applied will be   assigned to the load balancer. Additional Droplets will be automatically   assigned as they are tagged.  These methods are mutually exclusive.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_load_balancer(load_balancer_create, async_req=True)
        >>> result = thread.get()

        Args:
            load_balancer_create (LoadBalancerCreate):
    ...
    def delete_load_balancer(
        ...
        **kwargs
        ...
        >>> thread = api.delete_load_balancer(lb_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_load_balancer(
        ...
        **kwargs
        ...
        """Retrieve an Existing Load Balancer  # noqa: E501

        To show information about a load balancer instance, send a GET request to `/v2/load_balancers/$LOAD_BALANCER_ID`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_load_balancer(lb_id, async_req=True)
        >>> result = thread.get()
    ...
    def list_all_load_balancers(
        ...
        **kwargs
        ...
        """List All Load Balancers  # noqa: E501

        To list all of the load balancer instances on your account, send a GET request to `/v2/load_balancers`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_all_load_balancers(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_all_load_balancers_endpoint.call_with_http_info(**kwargs)

    def remove_load_balancer_droplets(
        self,
        lb_id,
        unknown_base_type,
        **kwargs
    ):
        """Remove Droplets from a Load Balancer  # noqa: E501
        ...
        >>> thread = api.remove_load_balancer_droplets(lb_id, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.remove_load_balancer_droplets_endpoint.call_with_http_info(**kwargs)

    def remove_load_balancer_forwarding_rules(
        self,
        lb_id,
        unknown_base_type,
        **kwargs
    ):
        """Remove Forwarding Rules from a Load Balancer  # noqa: E501
        ...
        >>> thread = api.remove_load_balancer_forwarding_rules(lb_id, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unknown_base_type'] = \
            unknown_base_type
        return self.remove_load_balancer_forwarding_rules_endpoint.call_with_http_info(**kwargs)
    ...
    def update_load_balancer(
        ...
        **kwargs
        ...
        >>> thread = api.update_load_balancer(lb_id, load_balancer_create, async_req=True)
        >>> result = thread.get()
