...
from digitalocean_client import rest
from digitalocean_client.configuration import Configuration
from digitalocean_client.exceptions import ApiTypeError, ApiValueError, ApiException
from digitalocean_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ClickApplicationsApi()
        api_instance.install_kubernetes  # this is an instance of the class Endpoint
        api_instance.install_kubernetes()  # this invokes api_instance.install_kubernetes.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.install_kubernetes.callable or self.callable in this class
