...
class DatabaseConnection(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DatabaseConnection - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            uri (str): A connection string in the format accepted by the `psql` command. This is provided as a convenience and should be able to be constructed by the other attributes.. [optional]  # noqa: E501
            database (str): The name of the default database.. [optional]  # noqa: E501
            host (str): The FQDN pointing to the database cluster's current primary node.. [optional]  # noqa: E501
            port (int): The port on which the database cluster is listening.. [optional]  # noqa: E501
            user (str): The default user for the database.. [optional]  # noqa: E501
            password (str): The randomly generated password for the default user.. [optional]  # noqa: E501
            ssl (bool): A boolean value indicating if the connection should be made over SSL.. [optional]  # noqa: E501
        """
