...
class DropletMultiCreateAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, names, *args, **kwargs):  # noqa: E501
        """DropletMultiCreateAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, names, *args, **kwargs):  # noqa: E501
        """DropletMultiCreateAllOf - a model defined in OpenAPI
