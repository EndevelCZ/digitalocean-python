...
class Firewall(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'pending_changes': ([FirewallAllOfPendingChanges],),  # noqa: E501
            'name': (str,),  # noqa: E501
            'droplet_ids': ([int], none_type,),  # noqa: E501
            'tags': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'inbound_rules': ([bool, date, datetime, dict, float, int, list, str, none_type], none_type,),  # noqa: E501
            'outbound_rules': ([bool, date, datetime, dict, float, int, list, str, none_type], none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'pending_changes': 'pending_changes',  # noqa: E501
        'name': 'name',  # noqa: E501
        'droplet_ids': 'droplet_ids',  # noqa: E501
        'tags': 'tags',  # noqa: E501
        'inbound_rules': 'inbound_rules',  # noqa: E501
        'outbound_rules': 'outbound_rules',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): A unique ID that can be used to identify and reference a firewall.. [optional]  # noqa: E501
            status (str): A status string indicating the current state of the firewall. This can be \"waiting\", \"succeeded\", or \"failed\".. [optional]  # noqa: E501
            created_at (datetime): A time value given in ISO8601 combined date and time format that represents when the firewall was created.. [optional]  # noqa: E501
            pending_changes ([FirewallAllOfPendingChanges]): An array of objects each containing the fields \"droplet_id\", \"removing\", and \"status\". It is provided to detail exactly which Droplets are having their security policies updated. When empty, all changes have been successfully applied.. [optional]  # noqa: E501
            name (str): A human-readable name for a firewall. The name must begin with an alphanumeric character. Subsequent characters must either be alphanumeric characters, a period (.), or a dash (-).. [optional]  # noqa: E501
            droplet_ids ([int], none_type): An array containing the IDs of the Droplets assigned to the firewall.. [optional]  # noqa: E501
            tags (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            inbound_rules ([bool, date, datetime, dict, float, int, list, str, none_type], none_type): [optional]  # noqa: E501
            outbound_rules ([bool, date, datetime, dict, float, int, list, str, none_type], none_type): [optional]  # noqa: E501
        """
