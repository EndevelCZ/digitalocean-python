...
class KubernetesNodePoolTaint(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """KubernetesNodePoolTaint - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            key (str): An arbitrary string. The `key` and `value` fields of the `taint` object form a key-value pair. For example, if the value of the `key` field is \"special\" and the value of the `value` field is \"gpu\", the key value pair would be `special=gpu`.. [optional]  # noqa: E501
            value (str): An arbitrary string. The `key` and `value` fields of the `taint` object form a key-value pair. For example, if the value of the `key` field is \"special\" and the value of the `value` field is \"gpu\", the key value pair would be `special=gpu`.. [optional]  # noqa: E501
            effect (str): How the node reacts to pods that it won't tolerate. Available effect values are `NoSchedule`, `PreferNoSchedule`, and `NoExecute`.. [optional]  # noqa: E501
        """
