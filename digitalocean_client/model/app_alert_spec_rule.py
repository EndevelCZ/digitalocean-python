...
class AppAlertSpecRule(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AppAlertSpecRule - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "UNSPECIFIED_RULE", must be one of ["UNSPECIFIED_RULE", "CPU_UTILIZATION", "MEM_UTILIZATION", "RESTART_COUNT", "DEPLOYMENT_FAILED", "DEPLOYMENT_LIVE", "DOMAIN_FAILED", "DOMAIN_LIVE", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "UNSPECIFIED_RULE", must be one of ["UNSPECIFIED_RULE", "CPU_UTILIZATION", "MEM_UTILIZATION", "RESTART_COUNT", "DEPLOYMENT_FAILED", "DEPLOYMENT_LIVE", "DOMAIN_FAILED", "DOMAIN_LIVE", ]  # noqa: E501
