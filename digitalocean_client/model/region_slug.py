...
class RegionSlug(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """RegionSlug - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The slug identifier for the region where the resource will initially be  available.., must be one of ["ams1", "ams2", "ams3", "blr1", "fra1", "lon1", "nyc1", "nyc2", "nyc3", "sfo1", "sfo2", "sfo3", "sgp1", "tor1", ]  # noqa: E501

        Keyword Args:
            value (str): The slug identifier for the region where the resource will initially be  available.., must be one of ["ams1", "ams2", "ams3", "blr1", "fra1", "lon1", "nyc1", "nyc2", "nyc3", "sfo1", "sfo2", "sfo3", "sgp1", "tor1", ]  # noqa: E501
