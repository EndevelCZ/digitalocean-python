...
class InlineResponse2011(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'database': (DatabaseCluster,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, database, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, database, *args, **kwargs):  # noqa: E501
        """InlineResponse2011 - a model defined in OpenAPI
