...
class FirewallRuleBase(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, protocol, ports, *args, **kwargs):  # noqa: E501
        """FirewallRuleBase - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, protocol, ports, *args, **kwargs):  # noqa: E501
        """FirewallRuleBase - a model defined in OpenAPI
