...
class AppComponentBase(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppComponentBase - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): The name. Must be unique across all components within the same app.. [optional]  # noqa: E501
