...
class DropletNextBackupWindow(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DropletNextBackupWindow - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            start (datetime): A time value given in ISO8601 combined date and time format specifying the start of the Droplet's backup window.. [optional]  # noqa: E501
            end (datetime): A time value given in ISO8601 combined date and time format specifying the end of the Droplet's backup window.. [optional]  # noqa: E501
        """
