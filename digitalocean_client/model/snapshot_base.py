...
class SnapshotBase(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'min_disk_size': (int,),  # noqa: E501
            'size_gigabytes': (float,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, created_at, regions, min_disk_size, size_gigabytes, *args, **kwargs):  # noqa: E501
        """SnapshotBase - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, created_at, regions, min_disk_size, size_gigabytes, *args, **kwargs):  # noqa: E501
        """SnapshotBase - a model defined in OpenAPI
