...
class FirewallRule(ModelNormal):
    ...
    attribute_map = {
        ...
        'uuid': 'uuid',  # noqa: E501
        'cluster_uuid': 'cluster_uuid',  # noqa: E501
    ...
    def _from_openapi_data(cls, type, value, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            uuid (str): A unique ID for the firewall rule itself.. [optional]  # noqa: E501
            cluster_uuid (str): A unique ID for the database cluster to which the rule is applied.. [optional]  # noqa: E501
            created_at (datetime): A time value given in ISO8601 combined date and time format that represents when the firewall rule was created.. [optional]  # noqa: E501
        """
