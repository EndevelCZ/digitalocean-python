...
class VolumeAction(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'resource_id': (int, none_type,),  # noqa: E501
            'id': (int,),  # noqa: E501
            ...
            'region_slug': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'region': 'region',  # noqa: E501
        'region_slug': 'region_slug',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VolumeAction - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): This is the type of action that the object represents. For example, this could be \"transfer\" to represent the state of an image transfer action.. [optional]  # noqa: E501
            resource_id (int, none_type): A unique identifier for the resource that the action is associated with.. [optional]  # noqa: E501
            id (int): A unique numeric ID that can be used to identify and reference an action.. [optional]  # noqa: E501
            status (str): The current status of the action. This can be \"in-progress\", \"completed\", or \"errored\".. [optional] if omitted the server will use the default value of "in-progress"  # noqa: E501
            started_at (datetime): A time value given in ISO8601 combined date and time format that represents when the action was initiated.. [optional]  # noqa: E501
            completed_at (datetime, none_type): A time value given in ISO8601 combined date and time format that represents when the action was completed.. [optional]  # noqa: E501
            resource_type (str): The type of resource that the action is associated with.. [optional]  # noqa: E501
            region (Region): [optional]  # noqa: E501
            region_slug (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
        """
