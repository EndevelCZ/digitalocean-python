...
class LoadBalancerBase(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, forwarding_rules, *args, **kwargs):  # noqa: E501
        """LoadBalancerBase - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, forwarding_rules, *args, **kwargs):  # noqa: E501
        """LoadBalancerBase - a model defined in OpenAPI
