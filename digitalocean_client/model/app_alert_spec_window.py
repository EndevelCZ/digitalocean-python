...
class AppAlertSpecWindow(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AppAlertSpecWindow - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "UNSPECIFIED_WINDOW", must be one of ["UNSPECIFIED_WINDOW", "FIVE_MINUTES", "TEN_MINUTES", "THIRTY_MINUTES", "ONE_HOUR", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "UNSPECIFIED_WINDOW", must be one of ["UNSPECIFIED_WINDOW", "FIVE_MINUTES", "TEN_MINUTES", "THIRTY_MINUTES", "ONE_HOUR", ]  # noqa: E501
