...
class KubernetesNodePoolBase(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'taints': ([KubernetesNodePoolTaint],),  # noqa: E501
            'auto_scale': (bool,),  # noqa: E501
            'min_nodes': (int,),  # noqa: E501
            'max_nodes': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'auto_scale': 'auto_scale',  # noqa: E501
        'min_nodes': 'min_nodes',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """KubernetesNodePoolBase - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): A unique ID that can be used to identify and reference a specific node pool.. [optional]  # noqa: E501
            name (str): A human-readable name for the node pool.. [optional]  # noqa: E501
            count (int): The number of Droplet instances in the node pool.. [optional]  # noqa: E501
            tags ([str]): An array containing the tags applied to the node pool. All node pools are automatically tagged `k8s`, `k8s-worker`, and `k8s:$K8S_CLUSTER_ID`.. [optional]  # noqa: E501
            labels ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): An object containing a set of Kubernetes labels. The keys and are values are both user-defined.. [optional]  # noqa: E501
            taints ([KubernetesNodePoolTaint]): An array of taints to apply to all nodes in a pool. Taints will automatically be applied to all existing nodes and any subsequent nodes added to the pool. When a taint is removed, it is removed from all nodes in the pool.. [optional]  # noqa: E501
            auto_scale (bool): A boolean value indicating whether auto-scaling is enabled for this node pool.. [optional]  # noqa: E501
            min_nodes (int): The minimum number of nodes that this node pool can be auto-scaled to. The value will be `0` if `auto_scale` is set to `false`.. [optional]  # noqa: E501
            max_nodes (int): The maximum number of nodes that this node pool can be auto-scaled to. The value will be `0` if `auto_scale` is set to `false`.. [optional]  # noqa: E501
            nodes ([Node]): An object specifying the details of a specific worker node in a node pool.. [optional]  # noqa: E501
        """
