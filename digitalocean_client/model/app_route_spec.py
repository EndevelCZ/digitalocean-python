...
class AppRouteSpec(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppRouteSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            path (str): An HTTP path prefix. Paths must start with / and must be unique across all components within an app.. [optional]  # noqa: E501
        """
