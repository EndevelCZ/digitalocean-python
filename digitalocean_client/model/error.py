...
class Error(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, message, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            request_id (str): Optionally, some endpoints may include a request ID that should be  provided when reporting bugs or opening support tickets to help  identify the issue.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, message, *args, **kwargs):  # noqa: E501
        """Error - a model defined in OpenAPI
