...
class Node(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'status': (NodeStatus,),  # noqa: E501
            'droplet_id': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'droplet_id': 'droplet_id',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): A unique ID that can be used to identify and reference the node.. [optional]  # noqa: E501
            name (str): An automatically generated, human-readable name for the node.. [optional]  # noqa: E501
            status (NodeStatus): [optional]  # noqa: E501
            droplet_id (str): The ID of the Droplet used for the worker node.. [optional]  # noqa: E501
            created_at (datetime): A time value given in ISO8601 combined date and time format that represents when the node was created.. [optional]  # noqa: E501
            updated_at (datetime): A time value given in ISO8601 combined date and time format that represents when the node was last updated.. [optional]  # noqa: E501
        """
