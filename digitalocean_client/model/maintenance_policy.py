...
class MaintenancePolicy(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            start_time (str): The start time in UTC of the maintenance window policy in 24-hour clock format / HH:MM notation (e.g., `15:00`).. [optional]  # noqa: E501
            duration (str): The duration of the maintenance window policy in human-readable format.. [optional]  # noqa: E501
            day (str): The day of the maintenance window policy. May be one of `monday` through `sunday`, or `any` to indicate an arbitrary week day.. [optional]  # noqa: E501
        """
