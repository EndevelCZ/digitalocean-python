...
def lazy_import():
    ...
    globals()['DropletActionRebuildAllOf'] = DropletActionRebuildAllOf
    globals()['DropletActionType'] = DropletActionType


class DropletActionRebuild(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DropletActionRebuild - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            image (bool, date, datetime, dict, float, int, list, str, none_type): The image ID of a public or private image or the slug identifier for a public image. The Droplet will be rebuilt using this image as its base.. [optional]  # noqa: E501
        """
