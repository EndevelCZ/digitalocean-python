...
class Account(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'droplet_limit': (int,),  # noqa: E501
            'floating_ip_limit': (int,),  # noqa: E501
            'email': (str,),  # noqa: E501
            'uuid': (str,),  # noqa: E501
    ...
    attribute_map = {
        'droplet_limit': 'droplet_limit',  # noqa: E501
        'floating_ip_limit': 'floating_ip_limit',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, droplet_limit, floating_ip_limit, email, uuid, status_message, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            email_verified (bool): If true, the user has verified their account via email. False otherwise.. defaults to False  # noqa: E501
            status (str): This value is one of \"active\", \"warning\" or \"locked\".. defaults to "active", must be one of ["active", "warning", "locked", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, droplet_limit, floating_ip_limit, email, uuid, status_message, *args, **kwargs):  # noqa: E501
        """Account - a model defined in OpenAPI
