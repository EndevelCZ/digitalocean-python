...
class Registry(ModelNormal):
    ...
    validations = {
        ('name',): {
            'max_length': 63,
            'regex': {
                'pattern': r'^[a-z0-9-]{1,63}$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'storage_usage_bytes_updated_at': (datetime,),  # noqa: E501
            'subscription': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'storage_usage_bytes': 'storage_usage_bytes',  # noqa: E501
        'storage_usage_bytes_updated_at': 'storage_usage_bytes_updated_at',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'storage_usage_bytes_updated_at',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): A globally unique name for the container registry. Must be lowercase and be composed only of numbers, letters and `-`, up to a limit of 63 characters.. [optional]  # noqa: E501
            created_at (datetime): A time value given in ISO8601 combined date and time format that represents when the registry was created.. [optional]  # noqa: E501
            storage_usage_bytes (int): The amount of storage used in the registry in bytes.. [optional]  # noqa: E501
            storage_usage_bytes_updated_at (datetime): The time at which the storage usage was updated. Storage usage is calculated asynchronously, and may not immediately reflect pushes to the registry.. [optional]  # noqa: E501
            subscription (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
        """
