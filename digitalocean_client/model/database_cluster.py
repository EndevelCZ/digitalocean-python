...
class DatabaseCluster(ModelNormal):
    ...
    validations = {
        ('private_network_uuid',): {
            'regex': {
                'pattern': r'^$|[0-9a-f]{8}\b-[0-9a-f]{4}-[0-9a-f]{4}-[0-9a-f]{4}-\b[0-9a-f]{12}',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'private_network_uuid': (str,),  # noqa: E501
            'tags': ([str], none_type,),  # noqa: E501
            'db_names': ([str], none_type,),  # noqa: E501
            'connection': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'private_connection': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'users': ([DatabaseUser], none_type,),  # noqa: E501
            'maintenance_window': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'private_network_uuid': 'private_network_uuid',  # noqa: E501
        'tags': 'tags',  # noqa: E501
        'db_names': 'db_names',  # noqa: E501
        'connection': 'connection',  # noqa: E501
        'private_connection': 'private_connection',  # noqa: E501
        'users': 'users',  # noqa: E501
        'maintenance_window': 'maintenance_window',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, engine, num_nodes, size, region, *args, **kwargs):  # noqa: E501
        """DatabaseCluster - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): A unique ID that can be used to identify and reference a database cluster.. [optional]  # noqa: E501
            version (str): A string representing the version of the database engine in use for the cluster.. [optional]  # noqa: E501
            status (str): A string representing the current status of the database cluster.. [optional]  # noqa: E501
            created_at (datetime): A time value given in ISO8601 combined date and time format that represents when the database cluster was created.. [optional]  # noqa: E501
            private_network_uuid (str): A string specifying the UUID of the VPC to which the database cluster will be assigned. If excluded, the cluster when creating a new database cluster, it will be assigned to your account's default VPC for the region.. [optional]  # noqa: E501
            tags ([str], none_type): An array of tags that have been applied to the database cluster.. [optional]  # noqa: E501
            db_names ([str], none_type): An array of strings containing the names of databases created in the database cluster.. [optional]  # noqa: E501
            connection (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            private_connection (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            users ([DatabaseUser], none_type): [optional]  # noqa: E501
            maintenance_window (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, engine, num_nodes, size, region, *args, **kwargs):  # noqa: E501
        """DatabaseCluster - a model defined in OpenAPI
