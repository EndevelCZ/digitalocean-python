...
class AssociatedKubernetesResources(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'load_balancers': ([AssociatedKubernetesResource],),  # noqa: E501
            'volumes': ([AssociatedKubernetesResource],),  # noqa: E501
            'volume_snapshots': ([AssociatedKubernetesResource],),  # noqa: E501
        }
    ...
    attribute_map = {
        'load_balancers': 'load_balancers',  # noqa: E501
        'volumes': 'volumes',  # noqa: E501
        'volume_snapshots': 'volume_snapshots',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AssociatedKubernetesResources - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            load_balancers ([AssociatedKubernetesResource]): A list of names and IDs for associated load balancers that can be destroyed along with the cluster.. [optional]  # noqa: E501
            volumes ([AssociatedKubernetesResource]): A list of names and IDs for associated volumes that can be destroyed along with the cluster.. [optional]  # noqa: E501
            volume_snapshots ([AssociatedKubernetesResource]): A list of names and IDs for associated volume snapshots that can be destroyed along with the cluster.. [optional]  # noqa: E501
        """
