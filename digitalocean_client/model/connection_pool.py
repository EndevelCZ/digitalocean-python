...
class ConnectionPool(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, mode, size, db, user, *args, **kwargs):  # noqa: E501
        """ConnectionPool - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, mode, size, db, user, *args, **kwargs):  # noqa: E501
        """ConnectionPool - a model defined in OpenAPI
