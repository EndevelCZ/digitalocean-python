...
class RegionsArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """RegionsArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([RegionSlug]): This attribute is an array of the regions that the image is available in. The regions are represented by their identifying slug values..  # noqa: E501

        Keyword Args:
            value ([RegionSlug]): This attribute is an array of the regions that the image is available in. The regions are represented by their identifying slug values..  # noqa: E501
