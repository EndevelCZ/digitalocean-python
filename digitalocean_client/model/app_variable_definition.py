...
class AppVariableDefinition(ModelNormal):
    ...
    validations = {
        ('key',): {
            'regex': {
                'pattern': r'^[_A-Za-z][_A-Za-z0-9]*$',  # noqa: E501
            },
        },
    }
    ...
    def _from_openapi_data(cls, key, *args, **kwargs):  # noqa: E501
        """AppVariableDefinition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            scope (str): - RUN_TIME: Made available only at run-time - BUILD_TIME: Made available only at build-time - RUN_AND_BUILD_TIME: Made available at both build and run-time. [optional] if omitted the server will use the default value of "RUN_AND_BUILD_TIME"  # noqa: E501
            type (str): - GENERAL: A plain-text environment variable - SECRET: A secret encrypted environment variable. [optional] if omitted the server will use the default value of "GENERAL"  # noqa: E501
            value (str): The value. If the type is `SECRET`, the value will be encrypted on first submission. On following submissions, the encrypted value should be used.. [optional]  # noqa: E501
        """
