...
class DatabaseClusterResize(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, size, num_nodes, *args, **kwargs):  # noqa: E501
        """DatabaseClusterResize - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, size, num_nodes, *args, **kwargs):  # noqa: E501
        """DatabaseClusterResize - a model defined in OpenAPI
