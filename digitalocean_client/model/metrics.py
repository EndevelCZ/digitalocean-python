...
class Metrics(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data, status, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, data, status, *args, **kwargs):  # noqa: E501
        """Metrics - a model defined in OpenAPI
