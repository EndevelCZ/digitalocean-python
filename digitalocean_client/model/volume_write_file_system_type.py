...
class VolumeWriteFileSystemType(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            'EXT4': NewVolumeExt4,
            'XFS': NewVolumeXfs,
            'new_volume_ext4': NewVolumeExt4,
            'new_volume_xfs': NewVolumeXfs,
        }
        if not val:
            return None
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, filesystem_type, *args, **kwargs):  # noqa: E501
        """VolumeWriteFileSystemType - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, filesystem_type, *args, **kwargs):  # noqa: E501
        """VolumeWriteFileSystemType - a model defined in OpenAPI
