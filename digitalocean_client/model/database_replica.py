...
class DatabaseReplica(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """DatabaseReplica - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            region (str): A slug identifier for the region where the read-only replica will be located. If excluded, the replica will be placed in the same region as the cluster.. [optional]  # noqa: E501
            size (str): A slug identifier representing the size of the node for the read-only replica. The size of the replica must be at least as large as the node size for the database cluster from which it is replicating.. [optional]  # noqa: E501
            status (str): A string representing the current status of the database cluster.. [optional]  # noqa: E501
            tags ([str]): A flat array of tag names as strings to apply to the read-only replica after it is created. Tag names can either be existing or new tags.. [optional]  # noqa: E501
            ...
            private_network_uuid (str): A string specifying the UUID of the VPC to which the read-only replica will be assigned. If excluded, the replica will be assigned to your account's default VPC for the region.. [optional]  # noqa: E501
