...
class TagsArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TagsArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str], none_type): A flat array of tag names as strings to be applied to the resource. Tag names may be for either existing or new tags..  # noqa: E501

        Keyword Args:
            value ([str], none_type): A flat array of tag names as strings to be applied to the resource. Tag names may be for either existing or new tags..  # noqa: E501
