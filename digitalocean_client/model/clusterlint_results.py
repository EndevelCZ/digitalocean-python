...
def lazy_import():
    ...
    globals()['ClusterlintResultsDiagnostics'] = ClusterlintResultsDiagnostics


class ClusterlintResults(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'diagnostics': ([ClusterlintResultsDiagnostics],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'requested_at': 'requested_at',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ClusterlintResults - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            run_id (str): Id of the clusterlint run that can be used later to fetch the diagnostics.. [optional]  # noqa: E501
            requested_at (datetime): A time value given in ISO8601 combined date and time format that represents when the schedule clusterlint run request was made.. [optional]  # noqa: E501
            completed_at (datetime): A time value given in ISO8601 combined date and time format that represents when the schedule clusterlint run request was completed.. [optional]  # noqa: E501
            diagnostics ([ClusterlintResultsDiagnostics]): An array of diagnostics reporting potential problems for the given cluster.. [optional]  # noqa: E501
        """
