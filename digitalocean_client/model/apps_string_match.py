...
class AppsStringMatch(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppsStringMatch - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            exact (str): Exact string match. Only 1 of `exact`, `prefix`, or `regex` must be set.. [optional]  # noqa: E501
            prefix (str): Prefix-based match. Only 1 of `exact`, `prefix`, or `regex` must be set.. [optional]  # noqa: E501
            regex (str): RE2 style regex-based match. Only 1 of `exact`, `prefix`, or `regex` must be set. For more information about RE2 syntax, see: https://github.com/google/re2/wiki/Syntax. [optional]  # noqa: E501
        """
