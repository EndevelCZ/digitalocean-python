...
class Alerts(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, slack, *args, **kwargs):  # noqa: E501
        """Alerts - a model defined in OpenAPI

        Args:
            email ([str]): An email to notify on an alert trigger.
            slack ([SlackDetails]): Slack integration details.
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, slack, *args, **kwargs):  # noqa: E501
        """Alerts - a model defined in OpenAPI
