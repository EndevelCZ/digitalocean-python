...
class Certificate(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sha1_fingerprint': (str,),  # noqa: E501
            'created_at': (datetime,),  # noqa: E501
            'dns_names': ([str],),  # noqa: E501
            'state': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'sha1_fingerprint': 'sha1_fingerprint',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): A unique ID that can be used to identify and reference a certificate.. [optional]  # noqa: E501
            name (str): A unique human-readable name referring to a certificate.. [optional]  # noqa: E501
            not_after (datetime): A time value given in ISO8601 combined date and time format that represents the certificate's expiration date.. [optional]  # noqa: E501
            sha1_fingerprint (str): A unique identifier generated from the SHA-1 fingerprint of the certificate.. [optional]  # noqa: E501
            created_at (datetime): A time value given in ISO8601 combined date and time format that represents when the certificate was created.. [optional]  # noqa: E501
            dns_names ([str]): An array of fully qualified domain names (FQDNs) for which the certificate was issued.. [optional]  # noqa: E501
            state (str): A string representing the current state of the certificate. It may be `pending`, `verified`, or `error`.. [optional]  # noqa: E501
            type (str): A string representing the type of the certificate. The value will be `custom` for a user-uploaded certificate or `lets_encrypt` for one automatically generated with Let's Encrypt.. [optional]  # noqa: E501
        """
