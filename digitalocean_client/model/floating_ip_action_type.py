...
class FloatingIpActionType(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'floating_ip_action_assign': FloatingIpActionAssign,
            'floating_ip_action_unassign': FloatingIpActionUnassign,
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """FloatingIpActionType - a model defined in OpenAPI
