...
class TagResource(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'resources': ([bool, date, datetime, dict, float, int, list, str, none_type],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resources, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, resources, *args, **kwargs):  # noqa: E501
        """TagResource - a model defined in OpenAPI
