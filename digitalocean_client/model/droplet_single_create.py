...
def lazy_import():
    ...
    globals()['DropletSingleCreateAllOf'] = DropletSingleCreateAllOf


class DropletSingleCreate(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'ssh_keys': ([bool, date, datetime, dict, float, int, list, str, none_type],),  # noqa: E501
            'backups': (bool,),  # noqa: E501
            'ipv6': (bool,),  # noqa: E501
            'monitoring': (bool,),  # noqa: E501
            'tags': ([str], none_type,),  # noqa: E501
            'user_data': (str,),  # noqa: E501
            'private_networking': (bool,),  # noqa: E501
            'vpc_uuid': (str,),  # noqa: E501
            'with_droplet_agent': (bool,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'private_networking': 'private_networking',  # noqa: E501
        'vpc_uuid': 'vpc_uuid',  # noqa: E501
        'with_droplet_agent': 'with_droplet_agent',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DropletSingleCreate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            ssh_keys ([bool, date, datetime, dict, float, int, list, str, none_type]): An array containing the IDs or fingerprints of the SSH keys that you wish to embed in the Droplet's root account upon creation.. [optional] if omitted the server will use the default value of []  # noqa: E501
            backups (bool): A boolean indicating whether automated backups should be enabled for the Droplet.. [optional] if omitted the server will use the default value of False  # noqa: E501
            ipv6 (bool): A boolean indicating whether to enable IPv6 on the Droplet.. [optional] if omitted the server will use the default value of False  # noqa: E501
            monitoring (bool): A boolean indicating whether to install the DigitalOcean agent for monitoring.. [optional] if omitted the server will use the default value of False  # noqa: E501
            tags ([str], none_type): A flat array of tag names as strings to apply to the Droplet after it is created. Tag names can either be existing or new tags.. [optional] if omitted the server will use the default value of []  # noqa: E501
            user_data (str): A string containing 'user data' which may be used to configure the Droplet on first boot, often a 'cloud-config' file or Bash script. It must be plain text and may not exceed 64 KiB in size.. [optional]  # noqa: E501
            private_networking (bool): This parameter has been deprecated. Use `vpc_uuid` instead to specify a VPC network for the Droplet. If no `vpc_uuid` is provided, the Droplet will be placed in your account's default VPC for the region.. [optional] if omitted the server will use the default value of False  # noqa: E501
            vpc_uuid (str): A string specifying the UUID of the VPC to which the Droplet will be assigned. If excluded, the Droplet will be assigned to your account's default VPC for the region.. [optional]  # noqa: E501
            with_droplet_agent (bool): A boolean indicating whether to install the DigitalOcean agent used for providing access to the Droplet web console in the control panel. By default, the agent is installed on new Droplets but installation errors (i.e. OS not supported) are ignored. To prevent it from being installed, set to `false`. To make installation errors fatal, explicitly set it to `true`.. [optional]  # noqa: E501
        """
