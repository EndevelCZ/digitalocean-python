...
class AppDatabaseSpec(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """AppDatabaseSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            cluster_name (str): The name of the underlying DigitalOcean DBaaS cluster. This is required for production databases. For dev databases, if cluster_name is not set, a new cluster will be provisioned.. [optional]  # noqa: E501
            db_name (str): The name of the MySQL or PostgreSQL database to configure.. [optional]  # noqa: E501
            db_user (str): The name of the MySQL or PostgreSQL user to configure.. [optional]  # noqa: E501
            engine (str): - MYSQL: MySQL - PG: PostgreSQL - REDIS: Redis. [optional] if omitted the server will use the default value of "UNSET"  # noqa: E501
            production (bool): Whether this is a production or dev database.. [optional]  # noqa: E501
            version (str): The version of the database engine. [optional]  # noqa: E501
        """
