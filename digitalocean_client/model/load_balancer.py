...
from digitalocean_client.exceptions import ApiAttributeError
...
def lazy_import():
    ...
    globals()['LoadBalancerAllOf1'] = LoadBalancerAllOf1
...
class LoadBalancer(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'forwarding_rules': ([ForwardingRule],),  # noqa: E501
            'id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'ip': (str,),  # noqa: E501
            'size_unit': (int,),  # noqa: E501
            'size': (str,),  # noqa: E501
            ...
            'redirect_http_to_https': (bool,),  # noqa: E501
            'enable_proxy_protocol': (bool,),  # noqa: E501
            'enable_backend_keepalive': (bool,),  # noqa: E501
            'vpc_uuid': (str,),  # noqa: E501
            'disable_lets_encrypt_dns_records': (bool,),  # noqa: E501
            'region': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'droplet_ids': ([int],),  # noqa: E501
            'tag': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        'forwarding_rules': 'forwarding_rules',  # noqa: E501
        'id': 'id',  # noqa: E501
        'name': 'name',  # noqa: E501
        'ip': 'ip',  # noqa: E501
        'size_unit': 'size_unit',  # noqa: E501
        'size': 'size',  # noqa: E501
        'algorithm': 'algorithm',  # noqa: E501
        'status': 'status',  # noqa: E501
        'created_at': 'created_at',  # noqa: E501
        'health_check': 'health_check',  # noqa: E501
        'sticky_sessions': 'sticky_sessions',  # noqa: E501
        'redirect_http_to_https': 'redirect_http_to_https',  # noqa: E501
        'enable_proxy_protocol': 'enable_proxy_protocol',  # noqa: E501
        'enable_backend_keepalive': 'enable_backend_keepalive',  # noqa: E501
        'vpc_uuid': 'vpc_uuid',  # noqa: E501
        'disable_lets_encrypt_dns_records': 'disable_lets_encrypt_dns_records',  # noqa: E501
        'region': 'region',  # noqa: E501
        'droplet_ids': 'droplet_ids',  # noqa: E501
        'tag': 'tag',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            forwarding_rules ([ForwardingRule]): An array of objects specifying the forwarding rules for a load balancer.
            ...
            id (str): A unique ID that can be used to identify and reference a load balancer.. [optional]  # noqa: E501
            name (str): A human-readable name for a load balancer instance.. [optional]  # noqa: E501
            ip (str): An attribute containing the public-facing IP address of the load balancer.. [optional]  # noqa: E501
            ...
            size (str): This field has been replaced by the `size_unit` field for all regions except in AMS2, NYC2, and SFO1. Each available load balancer size now equates to the load balancer having a set number of nodes. * `lb-small` = 1 node * `lb-medium` = 3 nodes * `lb-large` = 6 nodes  You can resize load balancers after creation up to once per hour. You cannot resize a load balancer within the first hour of its creation.. [optional] if omitted the server will use the default value of "lb-small"  # noqa: E501
            algorithm (str): This field has been deprecated. You can no longer specify an algorithm for load balancers.. [optional] if omitted the server will use the default value of "round_robin"  # noqa: E501
            status (str): A status string indicating the current state of the load balancer. This can be `new`, `active`, or `errored`.. [optional]  # noqa: E501
            created_at (datetime): A time value given in ISO8601 combined date and time format that represents when the load balancer was created.. [optional]  # noqa: E501
            health_check (HealthCheck): [optional]  # noqa: E501
            sticky_sessions (StickySessions): [optional]  # noqa: E501
            redirect_http_to_https (bool): A boolean value indicating whether HTTP requests to the load balancer on port 80 will be redirected to HTTPS on port 443.. [optional] if omitted the server will use the default value of False  # noqa: E501
            enable_proxy_protocol (bool): A boolean value indicating whether PROXY Protocol is in use.. [optional] if omitted the server will use the default value of False  # noqa: E501
            enable_backend_keepalive (bool): A boolean value indicating whether HTTP keepalive connections are maintained to target Droplets.. [optional] if omitted the server will use the default value of False  # noqa: E501
            vpc_uuid (str): A string specifying the UUID of the VPC to which the load balancer is assigned.. [optional]  # noqa: E501
            disable_lets_encrypt_dns_records (bool): A boolean value indicating whether to disable automatic DNS record creation for Let's Encrypt certificates that are added to the load balancer.. [optional] if omitted the server will use the default value of False  # noqa: E501
            region ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
            droplet_ids ([int]): An array containing the IDs of the Droplets assigned to the load balancer.. [optional]  # noqa: E501
            tag (str): The name of a Droplet tag corresponding to Droplets assigned to the load balancer.. [optional]  # noqa: E501
        """
