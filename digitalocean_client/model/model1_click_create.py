...
class Model1ClickCreate(ModelNormal):
    ...
    attribute_map = {
        'addon_slugs': 'addon_slugs',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cluster_uuid, *args, **kwargs):  # noqa: E501
        """Model1ClickCreate - a model defined in OpenAPI

        Args:
            cluster_uuid (str): A unique ID for the Kubernetes cluster to which the 1-Click Applications will be installed.

        Keyword Args:
            addon_slugs ([str]): An array of 1-Click Application slugs to be installed to the Kubernetes cluster.. defaults to []  # noqa: E501
        ...
        addon_slugs = kwargs.get('addon_slugs', [])
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_uuid, *args, **kwargs):  # noqa: E501
        """Model1ClickCreate - a model defined in OpenAPI
