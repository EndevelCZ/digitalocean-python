...
def lazy_import():
    ...
    globals()['AppServiceSpecAllOf'] = AppServiceSpecAllOf
    globals()['AppServiceSpecHealthCheck'] = AppServiceSpecHealthCheck
...
class AppServiceSpec(ModelComposed):
    ...
    validations = {
        ('name',): {
            ...
            'min_length': 2,
            'regex': {
                'pattern': r'^[a-z][a-z0-9-]{0,30}[a-z0-9]$',  # noqa: E501
            },
        },
        ('instance_count',): {
            'inclusive_minimum': 1,
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'git': (AppsGitSourceSpec,),  # noqa: E501
            'github': (AppsGithubSourceSpec,),  # noqa: E501
            'gitlab': (AppsGitlabSourceSpec,),  # noqa: E501
            'image': (AppsImageSourceSpec,),  # noqa: E501
            'dockerfile_path': (str,),  # noqa: E501
            'build_command': (str,),  # noqa: E501
            'run_command': (str,),  # noqa: E501
            'source_dir': (str,),  # noqa: E501
            'envs': ([AppVariableDefinition],),  # noqa: E501
            'environment_slug': (str,),  # noqa: E501
            'instance_count': (int,),  # noqa: E501
            'instance_size_slug': (str,),  # noqa: E501
            'cors': (AppsCorsPolicy,),  # noqa: E501
            'health_check': (AppServiceSpecHealthCheck,),  # noqa: E501
            'http_port': (int,),  # noqa: E501
            'internal_ports': ([int],),  # noqa: E501
            'routes': ([AppRouteSpec],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'build_command': 'build_command',  # noqa: E501
        'run_command': 'run_command',  # noqa: E501
        'source_dir': 'source_dir',  # noqa: E501
        'envs': 'envs',  # noqa: E501
        'environment_slug': 'environment_slug',  # noqa: E501
        'instance_count': 'instance_count',  # noqa: E501
        'instance_size_slug': 'instance_size_slug',  # noqa: E501
        'cors': 'cors',  # noqa: E501
        'health_check': 'health_check',  # noqa: E501
        'http_port': 'http_port',  # noqa: E501
        'internal_ports': 'internal_ports',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppServiceSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            git (AppsGitSourceSpec): [optional]  # noqa: E501
            github (AppsGithubSourceSpec): [optional]  # noqa: E501
            gitlab (AppsGitlabSourceSpec): [optional]  # noqa: E501
            image (AppsImageSourceSpec): [optional]  # noqa: E501
            dockerfile_path (str): The path to the Dockerfile relative to the root of the repo. If set, it will be used to build this component. Otherwise, App Platform will attempt to build it using buildpacks.. [optional]  # noqa: E501
            build_command (str): An optional build command to run while building this component from source.. [optional]  # noqa: E501
            run_command (str): An optional run command to override the component's default.. [optional]  # noqa: E501
            source_dir (str): An optional path to the working directory to use for the build. For Dockerfile builds, this will be used as the build context. Must be relative to the root of the repo.. [optional]  # noqa: E501
            envs ([AppVariableDefinition]): A list of environment variables made available to the component.. [optional]  # noqa: E501
            environment_slug (str): An environment slug describing the type of this app. For a full list, please refer to [the product documentation](https://www.digitalocean.com/docs/app-platform/).. [optional]  # noqa: E501
            instance_count (int): The amount of instances that this component should be scaled to. Default: 1. [optional] if omitted the server will use the default value of 1  # noqa: E501
            instance_size_slug (str): The instance size to use for this component. Default: `basic-xxs`. [optional] if omitted the server will use the default value of "basic-xxs"  # noqa: E501
            cors (AppsCorsPolicy): [optional]  # noqa: E501
            health_check (AppServiceSpecHealthCheck): [optional]  # noqa: E501
            http_port (int): The internal port on which this service's run command will listen. Default: 8080 If there is not an environment variable with the name `PORT`, one will be automatically added with its value set to the value of this field.. [optional]  # noqa: E501
            internal_ports ([int]): The ports on which this service will listen for internal traffic.. [optional]  # noqa: E501
            routes ([AppRouteSpec]): A list of HTTP routes that should be routed to this component.. [optional]  # noqa: E501
        """
