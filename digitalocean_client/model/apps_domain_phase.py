...
class AppsDomainPhase(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AppsDomainPhase - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "UNKNOWN", must be one of ["UNKNOWN", "PENDING", "CONFIGURING", "ACTIVE", "ERROR", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "UNKNOWN", must be one of ["UNKNOWN", "PENDING", "CONFIGURING", "ACTIVE", "ERROR", ]  # noqa: E501
