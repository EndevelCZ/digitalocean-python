...
class AlertPolicyRequest(ModelNormal):
    ...
    allowed_values = {
        ...
        ('type',): {
            'LOAD_1': "v1/insights/droplet/load_1",
            'LOAD_5': "v1/insights/droplet/load_5",
            'LOAD_15': "v1/insights/droplet/load_15",
            'MEMORY_UTILIZATION_PERCENT': "v1/insights/droplet/memory_utilization_percent",
            'DISK_UTILIZATION_PERCENT': "v1/insights/droplet/disk_utilization_percent",
            'CPU': "v1/insights/droplet/cpu",
            'DISK_READ': "v1/insights/droplet/disk_read",
            'DISK_WRITE': "v1/insights/droplet/disk_write",
            'PUBLIC_OUTBOUND_BANDWIDTH': "v1/insights/droplet/public_outbound_bandwidth",
            'PUBLIC_INBOUND_BANDWIDTH': "v1/insights/droplet/public_inbound_bandwidth",
            'PRIVATE_OUTBOUND_BANDWIDTH': "v1/insights/droplet/private_outbound_bandwidth",
            'PRIVATE_INBOUND_BANDWIDTH': "v1/insights/droplet/private_inbound_bandwidth",
        },
        ('window',): {
            '5M': "5m",
            '10M': "10m",
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, alerts, compare, description, enabled, entities, tags, type, value, window, *args, **kwargs):  # noqa: E501
        """AlertPolicyRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, alerts, compare, description, enabled, entities, tags, type, value, window, *args, **kwargs):  # noqa: E501
        """AlertPolicyRequest - a model defined in OpenAPI
