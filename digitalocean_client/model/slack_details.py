...
class SlackDetails(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, channel, url, *args, **kwargs):  # noqa: E501
        """SlackDetails - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, channel, url, *args, **kwargs):  # noqa: E501
        """SlackDetails - a model defined in OpenAPI
