...
def lazy_import():
    ...
    globals()['DropletActionResizeAllOf'] = DropletActionResizeAllOf
    globals()['DropletActionType'] = DropletActionType


class DropletActionResize(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DropletActionResize - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            disk (bool): When `true`, the Droplet's disk will be resized in addition to its RAM and CPU. This is a permanent change and cannot be reversed as a Droplet's disk size cannot be decreased.. [optional]  # noqa: E501
            size (str): The slug identifier for the size to which you wish to resize the Droplet.. [optional]  # noqa: E501
        """
