...
class OnlineMigration(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OnlineMigration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): The ID of the currently running migration.. [optional]  # noqa: E501
            status (str): The current status of the migration.. [optional]  # noqa: E501
            created_at (str): The time the migration was initiated, in ISO 8601 format.. [optional]  # noqa: E501
        """
