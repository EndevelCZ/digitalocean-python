...
class Project(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): The unique universal identifier of this project.. [optional]  # noqa: E501
            owner_uuid (str): The unique universal identifier of the project owner.. [optional]  # noqa: E501
            owner_id (int): The integer id of the project owner.. [optional]  # noqa: E501
            name (str): The human-readable name for the project. The maximum length is 175 characters and the name must be unique.. [optional]  # noqa: E501
            description (str): The description of the project. The maximum length is 255 characters.. [optional]  # noqa: E501
            purpose (str): The purpose of the project. The maximum length is 255 characters. It can have one of the following values:  - Just trying out DigitalOcean - Class project / Educational purposes - Website or blog - Web Application - Service or API - Mobile Application - Machine learning / AI / Data processing - IoT - Operational / Developer tooling  If another value for purpose is specified, for example, \"your custom purpose\", your purpose will be stored as `Other: your custom purpose`. . [optional]  # noqa: E501
            environment (str): The environment of the project's resources.. [optional]  # noqa: E501
            created_at (datetime): A time value given in ISO8601 combined date and time format that represents when the project was created.. [optional]  # noqa: E501
            updated_at (datetime): A time value given in ISO8601 combined date and time format that represents when the project was updated.. [optional]  # noqa: E501
            is_default (bool): If true, all resources will be added to this project if no project is specified.. [optional]  # noqa: E501
        """
