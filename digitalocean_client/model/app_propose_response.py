...
class AppProposeResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'app_is_static': (bool,),  # noqa: E501
            'app_name_available': (bool,),  # noqa: E501
            'app_name_suggestion': (str,),  # noqa: E501
            'existing_static_apps': (str,),  # noqa: E501
            'spec': (AppSpec,),  # noqa: E501
            'app_cost': (int,),  # noqa: E501
            'app_tier_downgrade_cost': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        'app_is_static': 'app_is_static',  # noqa: E501
        'app_name_available': 'app_name_available',  # noqa: E501
        'app_name_suggestion': 'app_name_suggestion',  # noqa: E501
        'existing_static_apps': 'existing_static_apps',  # noqa: E501
        'spec': 'spec',  # noqa: E501
        'app_cost': 'app_cost',  # noqa: E501
        'app_tier_downgrade_cost': 'app_tier_downgrade_cost',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppProposeResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            app_is_static (bool): Indicates whether the app is a static app.. [optional]  # noqa: E501
            app_name_available (bool): Indicates whether the app name is available.. [optional]  # noqa: E501
            app_name_suggestion (str): The suggested name if the proposed app name is unavailable.. [optional]  # noqa: E501
            existing_static_apps (str): The maximum number of free static apps the account can have. We will charge you for any additional static apps.. [optional]  # noqa: E501
            spec (AppSpec): [optional]  # noqa: E501
            app_cost (int): The monthly cost of the proposed app in USD using the next pricing plan tier. For example, if you propose an app that uses the Basic tier, the `app_tier_upgrade_cost` field displays the monthly cost of the app if it were to use the Professional tier. If the proposed app already uses the most expensive tier, the field is empty.. [optional]  # noqa: E501
            app_tier_downgrade_cost (int): The monthly cost of the proposed app in USD using the previous pricing plan tier. For example, if you propose an app that uses the Professional tier, the `app_tier_downgrade_cost` field displays the monthly cost of the app if it were to use the Basic tier. If the proposed app already uses the lest expensive tier, the field is empty.. [optional]  # noqa: E501
        """
