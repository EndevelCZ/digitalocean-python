...
def lazy_import():
    ...
    globals()['MetricsResult'] = MetricsResult


class MetricsData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'result': ([MetricsResult],),  # noqa: E501
    ...
    def _from_openapi_data(cls, result, *args, **kwargs):  # noqa: E501
        """MetricsData - a model defined in OpenAPI

        Args:
            result ([MetricsResult]): Result of query.

        Keyword Args:
            result_type (str): defaults to "matrix", must be one of ["matrix", ]  # noqa: E501
        ...
        result_type = kwargs.get('result_type', "matrix")
