...
class VolumeActionPostAttachAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, droplet_id, *args, **kwargs):  # noqa: E501
        """VolumeActionPostAttachAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, droplet_id, *args, **kwargs):  # noqa: E501
        """VolumeActionPostAttachAllOf - a model defined in OpenAPI
