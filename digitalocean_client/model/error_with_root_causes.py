...
class ErrorWithRootCauses(ModelNormal):
    ...
    attribute_map = {
        ...
        'root_causes': 'root_causes',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, error, root_causes, *args, **kwargs):  # noqa: E501
        """ErrorWithRootCauses - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            messages ([str], none_type): A list of legacy error messages.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, error, root_causes, *args, **kwargs):  # noqa: E501
        """ErrorWithRootCauses - a model defined in OpenAPI
