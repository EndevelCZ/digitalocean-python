...
class CertificateRequestCustomAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, private_key, leaf_certificate, *args, **kwargs):  # noqa: E501
        """CertificateRequestCustomAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, private_key, leaf_certificate, *args, **kwargs):  # noqa: E501
        """CertificateRequestCustomAllOf - a model defined in OpenAPI
