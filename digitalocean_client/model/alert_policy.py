...
class AlertPolicy(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, alerts, compare, description, enabled, entities, tags, type, uuid, value, window, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, alerts, compare, description, enabled, entities, tags, type, uuid, value, window, *args, **kwargs):  # noqa: E501
        """AlertPolicy - a model defined in OpenAPI
