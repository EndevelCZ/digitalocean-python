...
class AppsImageSourceSpec(ModelNormal):
    ...
    attribute_map = {
        ...
        'registry_type': 'registry_type',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppsImageSourceSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            registry (str): The registry name. Must be left empty for the `DOCR` registry type.. [optional]  # noqa: E501
            registry_type (str): - DOCKER_HUB: The DockerHub container registry type. - DOCR: The DigitalOcean container registry type.. [optional]  # noqa: E501
            repository (str): The repository name.. [optional]  # noqa: E501
            tag (str): The repository tag. Defaults to `latest` if not provided.. [optional] if omitted the server will use the default value of "latest"  # noqa: E501
        """
