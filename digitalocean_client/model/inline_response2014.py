...
class InlineResponse2014(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, db, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, db, *args, **kwargs):  # noqa: E501
        """InlineResponse2014 - a model defined in OpenAPI
