...
class SshKey(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, public_key, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (int): A unique identification number for this key. Can be used to embed a  specific SSH key into a Droplet.. [optional]  # noqa: E501
            fingerprint (str): A unique identifier that differentiates this key from other keys using  a format that SSH recognizes. The fingerprint is created when the key is added to your account.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, public_key, name, *args, **kwargs):  # noqa: E501
        """SshKey - a model defined in OpenAPI
