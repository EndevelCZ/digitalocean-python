...
class DropletCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, region, size, image, *args, **kwargs):  # noqa: E501
        """DropletCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, region, size, image, *args, **kwargs):  # noqa: E501
        """DropletCreate - a model defined in OpenAPI
