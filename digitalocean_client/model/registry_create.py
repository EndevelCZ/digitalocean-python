...
class RegistryCreate(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'subscription_tier_slug': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        'name': 'name',  # noqa: E501
        'subscription_tier_slug': 'subscription_tier_slug',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, subscription_tier_slug, *args, **kwargs):  # noqa: E501
        """RegistryCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, subscription_tier_slug, *args, **kwargs):  # noqa: E501
        """RegistryCreate - a model defined in OpenAPI
