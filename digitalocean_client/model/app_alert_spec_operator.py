...
class AppAlertSpecOperator(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AppAlertSpecOperator - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "UNSPECIFIED_OPERATOR", must be one of ["UNSPECIFIED_OPERATOR", "GREATER_THAN", "LESS_THAN", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "UNSPECIFIED_OPERATOR", must be one of ["UNSPECIFIED_OPERATOR", "GREATER_THAN", "LESS_THAN", ]  # noqa: E501
