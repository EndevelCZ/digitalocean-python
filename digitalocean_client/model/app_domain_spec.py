...
class AppDomainSpec(ModelNormal):
    ...
    validations = {
        ('domain',): {
            ...
            'min_length': 4,
            'regex': {
                'pattern': r'^((xn--)?[a-zA-Z0-9]+(-[a-zA-Z0-9]+)*\.)+[a-zA-Z]{2,}\.?$',  # noqa: E501
            },
        },
    }
    ...
    def _from_openapi_data(cls, domain, *args, **kwargs):  # noqa: E501
        """AppDomainSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            wildcard (bool): Indicates whether the domain includes all sub-domains, in addition to the given domain. [optional]  # noqa: E501
            zone (str): Optional. If the domain uses DigitalOcean DNS and you would like App Platform to automatically manage it for you, set this to the name of the domain on your account.  For example, If the domain you are adding is `app.domain.com`, the zone could be `domain.com`.. [optional]  # noqa: E501
        """
