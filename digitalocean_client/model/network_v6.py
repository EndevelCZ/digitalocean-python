...
class NetworkV6(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NetworkV6 - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            ip_address (str): The IP address of the IPv6 network interface.. [optional]  # noqa: E501
            netmask (int): The netmask of the IPv6 network interface.. [optional]  # noqa: E501
            gateway (str): The gateway of the specified IPv6 network interface.. [optional]  # noqa: E501
            type (str): The type of the IPv6 network interface.  **Note**: IPv6 private  networking is not currently supported. . [optional] if omitted the server will use the default value of "public"  # noqa: E501
        """
