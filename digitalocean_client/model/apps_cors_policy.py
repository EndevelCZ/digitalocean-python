...
class AppsCorsPolicy(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppsCorsPolicy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            allow_origins ([AppsStringMatch]): The set of allowed CORS origins.. [optional]  # noqa: E501
            allow_methods ([str]): The set of allowed HTTP methods. This configures the `Access-Control-Allow-Methods` header.. [optional]  # noqa: E501
            allow_headers ([str]): The set of allowed HTTP request headers. This configures the `Access-Control-Allow-Headers` header.. [optional]  # noqa: E501
            expose_headers ([str]): The set of HTTP response headers that browsers are allowed to access. This configures the `Access-Control-Expose-Headers` header.. [optional]  # noqa: E501
            max_age (str): An optional duration specifying how long browsers can cache the results of a preflight request. This configures the `Access-Control-Max-Age` header.. [optional]  # noqa: E501
            allow_credentials (bool): Whether browsers should expose the response to the client-side JavaScript code when the request’s credentials mode is include. This configures the `Access-Control-Allow-Credentials` header.. [optional]  # noqa: E501
        """
