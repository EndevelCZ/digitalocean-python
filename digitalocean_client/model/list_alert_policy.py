...
class ListAlertPolicy(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'policies': ([AlertPolicy],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, policies, *args, **kwargs):  # noqa: E501
        """ListAlertPolicy - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, policies, *args, **kwargs):  # noqa: E501
        """ListAlertPolicy - a model defined in OpenAPI
