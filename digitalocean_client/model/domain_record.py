...
class DomainRecord(ModelNormal):
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """DomainRecord - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (int): A unique identifier for each domain record.. [optional]  # noqa: E501
            name (str): The host name, alias, or service being defined by the record.. [optional]  # noqa: E501
            data (str): Variable data depending on record type. For example, the \"data\" value for an A record would be the IPv4 address to which the domain will be mapped. For a CAA record, it would contain the domain name of the CA being granted permission to issue certificates.. [optional]  # noqa: E501
            priority (int, none_type): The priority for SRV and MX records.. [optional]  # noqa: E501
            port (int, none_type): The port for SRV records.. [optional]  # noqa: E501
            ttl (int): This value is the time to live for the record, in seconds. This defines the time frame that clients can cache queried information before a refresh should be requested.. [optional]  # noqa: E501
            weight (int, none_type): The weight for SRV records.. [optional]  # noqa: E501
            flags (int, none_type): An unsigned integer between 0-255 used for CAA records.. [optional]  # noqa: E501
            tag (str, none_type): The parameter tag for CAA records. Valid values are \"issue\", \"issuewild\", or \"iodef\". [optional]  # noqa: E501
        """
