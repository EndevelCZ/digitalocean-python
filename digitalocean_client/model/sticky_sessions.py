...
class StickySessions(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'cookie_name': (str,),  # noqa: E501
            'cookie_ttl_seconds': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        'type': 'type',  # noqa: E501
        'cookie_name': 'cookie_name',  # noqa: E501
        'cookie_ttl_seconds': 'cookie_ttl_seconds',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StickySessions - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): An attribute indicating how and if requests from a client will be persistently served by the same backend Droplet. The possible values are `cookies` or `none`.. [optional] if omitted the server will use the default value of "none"  # noqa: E501
            cookie_name (str): The name of the cookie sent to the client. This attribute is only returned when using `cookies` for the sticky sessions type.. [optional]  # noqa: E501
            cookie_ttl_seconds (int): The number of seconds until the cookie set by the load balancer expires. This attribute is only returned when using `cookies` for the sticky sessions type.. [optional]  # noqa: E501
        """
