...
class FloatingIp(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'droplet': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            ip (str): The public IP address of the floating IP. It also serves as its identifier.. [optional]  # noqa: E501
            region (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            droplet (bool, date, datetime, dict, float, int, list, str, none_type): The Droplet that the floating IP has been assigned to. When you query a floating IP, if it is assigned to a Droplet, the entire Droplet object will be returned. If it is not assigned, the value will be null.. [optional]  # noqa: E501
            locked (bool): A boolean value indicating whether or not the floating IP has pending actions preventing new ones from being submitted.. [optional]  # noqa: E501
        """
