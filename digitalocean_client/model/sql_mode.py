...
class SqlMode(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sql_mode, *args, **kwargs):  # noqa: E501
        """SqlMode - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, sql_mode, *args, **kwargs):  # noqa: E501
        """SqlMode - a model defined in OpenAPI
