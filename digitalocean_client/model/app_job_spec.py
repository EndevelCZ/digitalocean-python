...
def lazy_import():
    ...
    globals()['AppJobSpecAllOf'] = AppJobSpecAllOf
...
class AppJobSpec(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppJobSpec - a model defined in OpenAPI
