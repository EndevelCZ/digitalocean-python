...
class AppStaticSiteSpec(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'index_document': (str,),  # noqa: E501
            'error_document': (str,),  # noqa: E501
            'catchall_document': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'index_document': 'index_document',  # noqa: E501
        'error_document': 'error_document',  # noqa: E501
        'catchall_document': 'catchall_document',  # noqa: E501
        'output_dir': 'output_dir',  # noqa: E501
        'cors': 'cors',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppStaticSiteSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            index_document (str): The name of the index document to use when serving this static site. Default: index.html. [optional] if omitted the server will use the default value of "index.html"  # noqa: E501
            error_document (str): The name of the error document to use when serving this static site. Default: 404.html. If no such file exists within the built assets, App Platform will supply one.. [optional] if omitted the server will use the default value of "404.html"  # noqa: E501
            catchall_document (str): The name of the document to use as the fallback for any requests to documents that are not found when serving this static site. Only 1 of `catchall_document` or `error_document` can be set.. [optional]  # noqa: E501
            output_dir (str): An optional path to where the built assets will be located, relative to the build context. If not set, App Platform will automatically scan for these directory names: `_static`, `dist`, `public`, `build`.. [optional]  # noqa: E501
