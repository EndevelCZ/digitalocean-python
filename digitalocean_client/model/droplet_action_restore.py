...
def lazy_import():
    ...
    globals()['DropletActionRestoreAllOf'] = DropletActionRestoreAllOf
    globals()['DropletActionType'] = DropletActionType


class DropletActionRestore(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DropletActionRestore - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            image (int): The ID of a backup of the current Droplet instance to restore from.. [optional]  # noqa: E501
        """
