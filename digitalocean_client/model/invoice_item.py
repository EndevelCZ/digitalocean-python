...
class InvoiceItem(ModelNormal):
    ...
    attribute_map = {
        ...
        'resource_uuid': 'resource_uuid',  # noqa: E501
        'resource_id': 'resource_id',  # noqa: E501
        'group_description': 'group_description',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            product (str): Name of the product being billed in the invoice item.. [optional]  # noqa: E501
            resource_uuid (str): UUID of the resource billing in the invoice item if available.. [optional]  # noqa: E501
            resource_id (str): ID of the resource billing in the invoice item if available.. [optional]  # noqa: E501
            group_description (str): Description of the invoice item when it is a grouped set of usage, such  as DOKS or databases.. [optional]  # noqa: E501
            description (str): Description of the invoice item.. [optional]  # noqa: E501
            amount (str): Billed amount of this invoice item. Billed in USD.. [optional]  # noqa: E501
            duration (str): Duration of time this invoice item was used and subsequently billed.. [optional]  # noqa: E501
            duration_unit (str): Unit of time for duration.. [optional]  # noqa: E501
            start_time (str): Time the invoice item began to be billed for usage.. [optional]  # noqa: E501
            end_time (str): Time the invoice item stoped being billed for usage.. [optional]  # noqa: E501
            project_name (str): Name of the DigitalOcean Project this resource belongs to.. [optional]  # noqa: E501
        """
