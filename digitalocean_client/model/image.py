...
class Image(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'regions': (RegionsArray,),  # noqa: E501
            'created_at': (datetime,),  # noqa: E501
            'min_disk_size': (int, none_type,),  # noqa: E501
            'size_gigabytes': (float, none_type,),  # noqa: E501
            'description': (str,),  # noqa: E501
            'tags': (TagsArray,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'min_disk_size': 'min_disk_size',  # noqa: E501
        'size_gigabytes': 'size_gigabytes',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (int): A unique number that can be used to identify and reference a specific image.. [optional]  # noqa: E501
            name (str): The display name that has been given to an image.  This is what is shown in the control panel and is generally a descriptive title for the image in question.. [optional]  # noqa: E501
            type (str): Describes the kind of image. It may be one of \"snapshot\", \"backup\", or \"custom\". This specifies whether an image is a user-generated Droplet snapshot, automatically created Droplet backup, or a user-provided virtual machine image.. [optional]  # noqa: E501
            distribution (Distribution): [optional]  # noqa: E501
            slug (str, none_type): A uniquely identifying string that is associated with each of the DigitalOcean-provided public images. These can be used to reference a public image as an alternative to the numeric id.. [optional]  # noqa: E501
            public (bool): This is a boolean value that indicates whether the image in question is public or not. An image that is public is available to all accounts. A non-public image is only accessible from your account.. [optional]  # noqa: E501
            regions (RegionsArray): [optional]  # noqa: E501
            created_at (datetime): A time value given in ISO8601 combined date and time format that represents when the image was created.. [optional]  # noqa: E501
            min_disk_size (int, none_type): The minimum disk size in GB required for a Droplet to use this image.. [optional]  # noqa: E501
            size_gigabytes (float, none_type): The size of the image in gigabytes.. [optional]  # noqa: E501
            description (str): An optional free-form text field to describe an image.. [optional]  # noqa: E501
            tags (TagsArray): [optional]  # noqa: E501
            status (str): A status string indicating the state of a custom image. This may be `NEW`,  `available`, `pending`, `deleted`, or `retired`.. [optional]  # noqa: E501
            error_message (str): A string containing information about errors that may occur when importing  a custom image.. [optional]  # noqa: E501
        """
