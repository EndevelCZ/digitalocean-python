...
def lazy_import():
    ...
    globals()['NewVolumeXfsAllOf'] = NewVolumeXfsAllOf
...
class NewVolumeXfs(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'filesystem_label': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NewVolumeXfs - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            snapshot_id (str): The unique identifier for the volume snapshot from which to create the volume.. [optional]  # noqa: E501
            filesystem_label (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
        """
