...
class Urn(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """Urn - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The uniform resource name (URN) for the resource in the format do:resource_type:resource_id..  # noqa: E501

        Keyword Args:
            value (str): The uniform resource name (URN) for the resource in the format do:resource_type:resource_id..  # noqa: E501
