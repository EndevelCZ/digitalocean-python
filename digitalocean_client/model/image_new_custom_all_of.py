...
class ImageNewCustomAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ImageNewCustomAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            url (str): A URL from which the custom Linux virtual machine image may be retrieved.  The image it points to must be in the raw, qcow2, vhdx, vdi, or vmdk format.  It may be compressed using gzip or bzip2 and must be smaller than 100 GB after being decompressed.. [optional]  # noqa: E501
