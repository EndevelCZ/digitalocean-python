...
class CdnEndpoint(ModelNormal):
    ...
    attribute_map = {
        ...
        'custom_domain': 'custom_domain',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, origin, *args, **kwargs):  # noqa: E501
        """CdnEndpoint - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): A unique ID that can be used to identify and reference a CDN endpoint.. [optional]  # noqa: E501
            endpoint (str): The fully qualified domain name (FQDN) from which the CDN-backed content is served.. [optional]  # noqa: E501
            ttl (int): The amount of time the content is cached by the CDN's edge servers in seconds. TTL must be one of 60, 600, 3600, 86400, or 604800. Defaults to 3600 (one hour) when excluded.. [optional] if omitted the server will use the default value of 3600  # noqa: E501
            certificate_id (str): The ID of a DigitalOcean managed TLS certificate used for SSL when a custom subdomain is provided.. [optional]  # noqa: E501
            custom_domain (str): The fully qualified domain name (FQDN) of the custom subdomain used with the CDN endpoint.. [optional]  # noqa: E501
            created_at (datetime): A time value given in ISO8601 combined date and time format that represents when the CDN endpoint was created.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, origin, *args, **kwargs):  # noqa: E501
        """CdnEndpoint - a model defined in OpenAPI
