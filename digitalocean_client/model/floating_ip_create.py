...
class FloatingIpCreate(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FloatingIpCreate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            droplet_id (int): The ID of the Droplet that the floating IP will be assigned to.. [optional]  # noqa: E501
            region (str): The slug identifier for the region the floating IP will be reserved to.. [optional]  # noqa: E501
        """
