...
class DatabaseMaintenanceWindow(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, day, hour, *args, **kwargs):  # noqa: E501
        """DatabaseMaintenanceWindow - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            pending (bool): A boolean value indicating whether any maintenance is scheduled to be performed in the next window.. [optional]  # noqa: E501
            description ([str]): A list of strings, each containing information about a pending maintenance update.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, day, hour, *args, **kwargs):  # noqa: E501
        """DatabaseMaintenanceWindow - a model defined in OpenAPI
