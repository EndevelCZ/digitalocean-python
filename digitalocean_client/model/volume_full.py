...
class VolumeFull(ModelComposed):
    ...
    attribute_map = {
        ...
        'filesystem_type': 'filesystem_type',  # noqa: E501
        'filesystem_label': 'filesystem_label',  # noqa: E501
    }

    read_only_vars = {
        'id',  # noqa: E501
        'droplet_ids',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VolumeFull - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): The unique identifier for the block storage volume.. [optional]  # noqa: E501
            droplet_ids ([int], none_type): An array containing the IDs of the Droplets the volume is attached to. Note that at this time, a volume can only be attached to a single Droplet.. [optional]  # noqa: E501
            name (str): A human-readable name for the block storage volume. Must be lowercase and be composed only of numbers, letters and \"-\", up to a limit of 64 characters. The name must begin with a letter.. [optional]  # noqa: E501
            description (str): An optional free-form text field to describe a block storage volume.. [optional]  # noqa: E501
            size_gigabytes (int): The size of the block storage volume in GiB (1024^3).. [optional]  # noqa: E501
            created_at (str): A time value given in ISO8601 combined date and time format that represents when the block storage volume was created.. [optional]  # noqa: E501
            tags (TagsArray): [optional]  # noqa: E501
            region (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            filesystem_type (str): The type of filesystem currently in-use on the volume.. [optional]  # noqa: E501
            filesystem_label (str): The label currently applied to the filesystem.. [optional]  # noqa: E501
        """
